...
public class XincoExplorer extends JFrame {
	...
	private void initialize() {
		...
		xincoClientVersion.setVersion_mid(11);
	...
	private javax.swing.JDialog getJDialogConnection() {
		if(jDialogConnection == null) {
			...
			jDialogConnection.getRootPane().setDefaultButton(getJButtonDialogConnectionConnect());
		}
	...
	private javax.swing.JDialog getJDialogUser() {
		...
		if(jDialogUser == null) {
			...
			jDialogUser.getRootPane().setDefaultButton(getJButtonDialogUserSave());
		}
		//processing independent of creation
