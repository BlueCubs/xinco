...
//		XincoCoreUserServer user;
		...
		if (status == 0) {
			...
			if (current_location.compareTo("MainMenu") == 0) {
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td class=\"bigtext\">Edit Languages</td>");
				out.println("<td class=\"text\">Add new languages or delete unused ones.</td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td class=\"bigtext\">Edit Attributes</td>");
				out.println("<td class=\"text\">Add new attributes to data types or remove existing ones.</td>");
				out.println("</tr>");
				out.println("<tr>");
			...
			if (current_location.compareTo("LanguageAdmin") == 0) {
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td class=\"text\">Sign (ISO 639):</td>");
				...
				out.println("<tr>");
				out.println("<td class=\"bigtext\">ID:</td>");
				out.println("<td class=\"bigtext\">Sign (ISO 639):</td>");
				out.println("<td class=\"bigtext\">Designation:</td>");
				out.println("<td class=\"bigtext\">&nbsp;</td>");
				out.println("</tr>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td colspan=\"4\" class=\"text\">Languages can only be deleted if they are not referenced by other objects (e.g. folders, data)!</td>");
				out.println("</tr>");
				out.println("</table>");
			...
			if (current_location.compareTo("AttributesAdmin") == 0) {
				...
				out.println("<td class=\"bigtext\">ID:</td>");
				out.println("<td class=\"bigtext\">Designation:</td>");
				out.println("<td class=\"bigtext\">Description:</td>");
				out.println("<td class=\"bigtext\">&nbsp;</td>");
				out.println("</tr>");
			...
			if (current_location.compareTo("AttributesAdminSingle") == 0) {
				...
				try {
					...
					out.println("<table border=\"0\" cellspacing=\"10\" cellpadding=\"0\">");
					out.println("<tr>");
					out.println("<td class=\"text\">Position:</td>");
					...
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td class=\"text\">Data Type:</td>");
					...
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td class=\"text\">Size:</td>");
				...
				try {
					...
					out.println("<tr>");
					out.println("<td class=\"bigtext\" colspan=\"5\">Attributes of this Data Type:</td>");
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td class=\"bigtext\">Position:</td>");
					out.println("<td class=\"bigtext\">Designation:</td>");
					out.println("<td class=\"bigtext\">Data Type:</td>");
					out.println("<td class=\"bigtext\">Size:</td>");
					out.println("<td class=\"bigtext\">&nbsp;</td>");
					out.println("</tr>");
					...
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td class=\"text\" colspan=\"5\">* IMPORTANT: When removing attributes, all of their attribute values stored with data will be DELETED!</td>");
					out.println("</tr>");
