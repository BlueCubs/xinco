...
INSERT INTO `xinco_setting` (`id`, `description`, `int_value`, `string_value`, `bool_value`, `long_value`) VALUES ('4', 'general.copyright.date', '0', '2004-2010', 0, '0');
...
-- -----------------------------------------------------
INSERT INTO `xinco_dependency_type` (`id`, `xinco_dependency_behavior_id`, `designation`, `description`) VALUES ('1', '1', 'dependency.related', 'dependency.related.desc');
