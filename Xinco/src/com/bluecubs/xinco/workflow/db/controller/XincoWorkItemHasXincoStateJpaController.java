...
import com.bluecubs.xinco.workflow.db.XincoWorkItemHasXincoStatePK;
...
import com.bluecubs.xinco.workflow.db.XincoWorkItemParameter;
...
public class XincoWorkItemHasXincoStateJpaController {
    ...
    public void create(XincoWorkItemHasXincoState xincoWorkItemHasXincoState) throws PreexistingEntityException, Exception {
        ...
        xincoWorkItemHasXincoState.getXincoWorkItemHasXincoStatePK().setXincoStateId(xincoWorkItemHasXincoState.getXincoWorkflowState().getXincoWorkflowStatePK().getId());
