...
public class XincoCoreDataType implements java.io.Serializable {
    ...
    _equals =
        true
            ...
            && ((this.xinco_core_data_type_attributes == null
                    && other.getXinco_core_data_type_attributes() == null)
                || (this.xinco_core_data_type_attributes != null
                    && this.xinco_core_data_type_attributes.equals(
                        other.getXinco_core_data_type_attributes())));
    __equalsCalc = null;
    return _equals;
  }
  ...
  static {
    typeDesc.setXmlType(
        new javax.xml.namespace.QName("http://core.xinco.bluecubs.com", "XincoCoreDataType"));
