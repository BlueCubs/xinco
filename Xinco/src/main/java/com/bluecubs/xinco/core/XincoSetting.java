...
public class XincoSetting implements java.io.Serializable {
    ...
    _equals =
        true
            ...
            && ((this.string_value == null && other.getString_value() == null)
                || (this.string_value != null && this.string_value.equals(other.getString_value())))
  ...
  public synchronized int hashCode() {
    ...
    _hashCode += Long.valueOf(getLong_value()).hashCode();
  ...
  static {
    typeDesc.setXmlType(
        new javax.xml.namespace.QName("http://core.xinco.bluecubs.com", "XincoSetting"));
