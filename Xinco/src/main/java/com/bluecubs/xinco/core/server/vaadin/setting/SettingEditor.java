...
class SettingEditor extends Window implements Button.ClickListener {
  ...
  public SettingEditor(Item item) {
    ...
    editorForm.setItemDataSource(
        settingItem,
        asList("id", "description", "stringValue", "longValue", "boolValue", "intValue"));
    ...
    editorForm
        ...
        .setRequiredError(getResource().getString("message.missing.description"));
    ...
    editorForm
        ...
        .setRequiredError(getResource().getString("message.missing.value"));
    ...
    if (event.getButton() == saveButton) {
      XincoSetting setting =
          new XincoSettingJpaController(getEntityManagerFactory())
              .findXincoSetting(valueOf(editorForm.getField("id").getValue().toString()));
      ...
      if (!setting
          .getStringValue()
          .equals(editorForm.getField("stringValue").getValue().toString())) {
        modified = true;
  ...
  public void addListener(EditorSavedListener listener) {
    try {
      Method method =
          EditorSavedListener.class.getDeclaredMethod(
