package com.bluecubs.xinco.authentication;
...
public final class CurrentUser
{
  ...
  /**
   * Sets the name of the current user and stores it in the current
   * session.Using a {@code null} username will remove the username from the
   * session.
   *
