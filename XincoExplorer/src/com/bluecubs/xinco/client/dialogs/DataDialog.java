...
//set altered values
        ...
        ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject()).setXincoCoreLanguage(((XincoCoreLanguage) explorer.getSession().getServerLanguages().get(this.language.getSelectedIndex())));
