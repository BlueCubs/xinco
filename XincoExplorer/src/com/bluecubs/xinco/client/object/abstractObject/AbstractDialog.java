...
public abstract class AbstractDialog extends javax.swing.JDialog {
  ...
  protected HashMap<JTextField, String> textFields = new HashMap<>();
  protected HashMap<JTextArea, String> textAreas = new HashMap<>();
  protected HashMap<JTable, DefaultTableModel> tables = new HashMap<>();
  private final HashMap<JCheckBox, Boolean> checkBoxes = new HashMap<>();
  ...
  /**
   * Get a HashMap<JTextField, String> containing the fields of this Dialog and
  ...
  /**
   * Get a HashMap<JTextArea, String> containing the fields of this Dialog and
   * their default values.
   *
   * @return HashMap<JTextArea, String> containing the fields of this Dialog and
   * their default values
   */
  ...
  /**
   * Get a HashMap<JTable, DefaultTableModel> containing the fields of this
   * Dialog and their default values.
   *
   * @return HashMap<JTable, DefaultTableModel> containing the fields of this
   * Dialog and their default values
   */
