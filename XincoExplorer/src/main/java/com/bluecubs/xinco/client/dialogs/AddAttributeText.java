 ...
 *
 * <p>Name: AddAttributeText.java
 *
 * <p>Description: Add Attribute Text
 *
...
public class AddAttributeText extends AbstractDialog {
   ...
   * @param explorer
   */
  public AddAttributeText(
      java.awt.Frame parent, boolean modal, boolean viewOnly, XincoExplorer explorer) {
    super(parent, modal);
    setViewOnly(viewOnly);
    this.explorer = explorer;
    initComponents();
    setTitle(
        explorer.getResourceBundle().getString("window.addattributestext")
            + ": "
        ...
        layout
            ...
            .addGroup(
                ...
                layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 478, Short.MAX_VALUE)
