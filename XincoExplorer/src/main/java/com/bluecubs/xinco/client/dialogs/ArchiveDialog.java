 ...
 *
 * <p>Name: ArchiveDialog
 *
 * <p>Description: Archive Dialog
 *
 ...
 * <p>Who? When? What?
 *
 * <p>************************************************************ ArchiveDialog.java
 *
 * <p>Created on January 5, 2010, 9:17 AM
 */
...
public class ArchiveDialog extends AbstractDialog {
  ...
  public void setToDefaults() {
    ...
    ((DefaultComboBoxModel) archiveModelDropDown.getModel())
        .addElement(xerb.getString("window.archive.archivingmodel.none"));
    ((DefaultComboBoxModel) archiveModelDropDown.getModel())
        .addElement(xerb.getString("window.archive.archivingmodel.archivedate"));
    ((DefaultComboBoxModel) archiveModelDropDown.getModel())
        .addElement(xerb.getString("window.archive.archivingmodel.archivedays"));
    archiveModelDropDown.setSelectedIndex(
        (int)
            ((XincoAddAttribute)
                    ((XincoCoreData)
                            explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
  ...
  private void initComponents() {
    ...
    archiveModelDropDown.setModel(
        new javax.swing.DefaultComboBoxModel(
            new String[] {"Item 1", "Item 2", "Item 3", "Item 4"}));
    archiveModelDropDown.addActionListener(
                ...
                layout
                    ...
                    .add(
                        layout
                            ...
                            .add(
                                org.jdesktop.layout.GroupLayout.TRAILING,
                                layout.createSequentialGroup().add(okButton).add(21, 21, 21)))
                    .add(
                        layout
                            .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(cancelButton)
  ...
  private void okButtonActionPerformed(
    ...
    ((XincoAddAttribute)
            ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                .getXinco_add_attributes()
                .elementAt(4))
        .setAttrib_unsignedint(archiveModelDropDown.getSelectedIndex());
    int temp_year_int = 0;
    ...
    try {
      ...
      cal.set(
          Calendar.MONTH, archiveModelDropDown.getSelectedIndex() == 1 ? (temp_month_int - 1) : 0);
      cal.set(
          Calendar.DAY_OF_MONTH, archiveModelDropDown.getSelectedIndex() == 1 ? temp_day_int : 0);
      ...
      ((XincoAddAttribute)
              ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                  .getXinco_add_attributes()
                  .elementAt(6))
          .setAttrib_unsignedint(temp_days_int);
      // close dialog
  ...
  private void archiveModelDropDownActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_archiveModelDropDownActionPerformed
