 ...
 *
 * <p>Name: ConnectionDialog
 *
 * <p>Description: Connection Dialog
 *
 ...
 * <p>Who? When? What?
 *
 * <p>************************************************************ ConnectionDialog.java
 *
 * <p>Created on September 25, 2006, 3:59 PM
 */
 ...
 */
public final class ConnectionDialog extends AbstractDialog {
  ...
  protected void initialize() {
    ...
    this.profileLabel.setText(
        explorer.getResourceBundle().getString("window.connection.profilename") + ":");
    ...
    this.deleteProfile.setText(
        explorer.getResourceBundle().getString("window.connection.deleteprofile"));
    this.profileNameLabel.setText(
        explorer.getResourceBundle().getString("window.connection.profile"));
    this.endpointLabel.setText(
        explorer.getResourceBundle().getString("window.connection.serverendpoint"));
    ...
    this.savePWLabel.setText(
        explorer.getResourceBundle().getString("window.connection.savepassword"));
    DefaultListModel dlm = new DefaultListModel();
    this.profileList.setModel(dlm);
    this.profileList.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    this.profileList.addListSelectionListener(
              ...
              profileName.setText(
                  ((XincoClientConnectionProfile)
                          ((Vector)
                                  explorer
                                      .getConfig()
                                      .get(ConfigElement.CONNECTION_PROFILE.ordinal()))
                              .get(sel))
                      .profile_name);
              endpoint.setText(
                  ((XincoClientConnectionProfile)
    ...
    for (int i = 0;
        i < ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal())).size();
        i++) {
      dlm.addElement(
          ((XincoClientConnectionProfile)
                  ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal()))
                      .get(i))
              .toString());
    }
  }
  ...
  private void connectActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_connectActionPerformed
    // save session info
    ...
    if (profileList.getSelectedIndex() >= 0) {
      Logger.getLogger(ConnectionDialog.class.getSimpleName())
          .log(Level.FINE, "Updating profile...");
      ((XincoClientConnectionProfile)
                  ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal()))
                      .get(profileList.getSelectedIndex()))
              .profile_name =
          profileName.getText();
      ((XincoClientConnectionProfile)
                  ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal()))
      ...
      if (savePW.isSelected()) {
        Logger.getLogger(ConnectionDialog.class.getSimpleName())
            .log(Level.FINE, "Saving password...");
        ((XincoClientConnectionProfile)
                    ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal()))
                        .get(profileList.getSelectedIndex()))
                .password =
        ...
        Logger.getLogger(ConnectionDialog.class.getSimpleName())
            .log(Level.FINE, "Not saving password...");
        ((XincoClientConnectionProfile)
                    ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal()))
                        .get(profileList.getSelectedIndex()))
                .password =
    ...
    explorer.saveConfig();
    setVisible(false);
    Logger.getLogger(ConnectionDialog.class.getSimpleName()).log(Level.FINE, "Done!");
  } // GEN-LAST:event_connectActionPerformed

  private void deleteProfileActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_deleteProfileActionPerformed
    int sel;
  ...
  private void CreateActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_CreateActionPerformed
    ...
    if (this.profileList.getSelectedIndex() >= 0) {
      ((XincoClientConnectionProfile)
                  ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal()))
                      .get(this.profileList.getSelectedIndex()))
              .profile_name =
    ...
    this.profileList.setSelectedIndex(
        ((Vector) explorer.getConfig().get(ConfigElement.CONNECTION_PROFILE.ordinal())).size() - 1);
