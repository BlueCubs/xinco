 ...
 * <p>************************************************************ DataDialog.java
 *
 * <p>Created on November 22, 2006, 10:38 AM
 */
...
public class DataDialog extends AbstractDialog {
  ...
  public void setToDefaults() {
    ...
    if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject() != null) {
      ...
      for (i = 0; i < explorer.getSession().getServerLanguages().size(); i++) {
        ...
        if (((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                .getId()
            == 0) {
  ...
  private void saveActionPerformed(
    ...
    // set altered values
    ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
        .setDesignation(this.designation.getText());
    ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
