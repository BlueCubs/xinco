 ...
 *
 * <p>Name: DataFolderDialog
 *
 * <p>Description: Data Folder Dialog
 *
 ...
 * <p>Who? When? What?
 *
 * <p>************************************************************ DataFolderDialog.java
 *
 * <p>Created on November 21, 2006, 4:23 PM
 */
...
public class DataFolderDialog extends AbstractDialog {
  ...
  public void setToDefaults() {
    ...
    if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject() != null) {
      ...
      for (i = 0; i < explorer.getSession().getServerLanguages().size(); i++) {
        ...
        if (((XincoCoreNode) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                .getId()
            == 0) {
  ...
  private void cancelActionPerformed(
    ...
    if (((XincoCoreNode) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
      ...
      explorer
          .getSession()
          .setCurrentTreeNodeSelection(
              (XincoMutableTreeNode)
                  explorer.getSession().getCurrentTreeNodeSelection().getParent());
  ...
  private void saveActionPerformed(
    ...
    newnode.setXinco_core_language(
        ((XincoCoreLanguage)
            explorer
                .getSession()
                .getServerLanguages()
                .elementAt(this.language.getSelectedIndex())));
    try {
      // optimize node size
      ...
      if ((newnode =
              explorer
                  .getSession()
                  .getXinco()
                  .setXincoCoreNode(newnode, explorer.getSession().getUser()))
          == null) {
      ...
      explorer.jLabelInternalFrameInformationText.setText(
          explorer.getResourceBundle().getString("window.folder.updatesuccess"));
