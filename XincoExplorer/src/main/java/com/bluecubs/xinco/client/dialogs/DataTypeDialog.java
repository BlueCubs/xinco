 ...
 *
 * <p>Name: DataTypeDialog
 *
 * <p>Description: Data Type Dialog
 *
 ...
 * <p>Who? When? What?
 *
 * <p>************************************************************ DataTypeDialog.java
 *
 * <p>Created on November 22, 2006, 8:44 AM
 */
  ...
  public void setToDefaults() {
    ...
    if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject() != null) {
      ...
      for (i = 0; i < explorer.getSession().getServerDatatypes().size(); i++) {
        String desc =
            ((XincoCoreDataType) explorer.getSession().getServerDatatypes().elementAt(i))
                .getDescription();
        String designation =
            ((XincoCoreDataType) explorer.getSession().getServerDatatypes().elementAt(i))
                .getDesignation();
        text =
            (explorer.getResourceBundle().getString(designation) == null
                    ? designation
                    : explorer.getResourceBundle().getString(designation))
                + " ("
                + (explorer.getResourceBundle().getString(desc) == null
                    ? desc
                    : explorer.getResourceBundle().getString(desc))
                + ")";
        dlm.addElement(text);
        if (((XincoCoreDataType) explorer.getSession().getServerDatatypes().elementAt(i)).getId()
        ...
        .setXinco_core_data_type(
            (XincoCoreDataType)
                explorer
                    .getSession()
                    .getServerDatatypes()
                    .elementAt(this.dataType.getSelectedIndex()));
