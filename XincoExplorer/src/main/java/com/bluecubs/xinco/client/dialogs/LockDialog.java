 ...
 * <p>Name: LockDialog
 *
 * <p>Description: Lock Dialog
 *
 * <p>Original Author: Javier A. Ortiz Date: March 12, 2010, 11:09 AM
 *
 * <p>Modifications:
 *
 * <p>Who? When? What?
...
public class LockDialog extends AbstractDialog {
            ...
            .addGroup(
                ...
                layout
                    ...
                    .addComponent(
                        ...
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED, 7, Short.MAX_VALUE)
                    .addComponent(passwordLabel)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        password,
          ...
          temp =
              this.explorer
                  ...
                  .getCurrentXincoCoreUser(
                      this.username.getText(), new String(this.password.getPassword()));
      if (temp == null) {
        ...
        if (!temp.getUsername().equals(this.explorer.getSession().getUser().getUsername())) {
          ...
          xnode =
              this.explorer
                  .getSession()
                  .getXinco()
                  .getXincoCoreNode(xnode, this.explorer.getSession().getUser());
          this.explorer
              .getSession()
              .getXincoClientRepository()
              .assignObject2TreeNode(
                  (XincoMutableTreeNode)
                      (this.explorer.getSession().getXincoClientRepository().treemodel).getRoot(),
                  xnode,
                  this.explorer.getSession().getXinco(),
  ...
  private void disconnectActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_disconnectActionPerformed
    this.setVisible(false);
    this.explorer.setLock(false);
    this.explorer.resetTimer();
