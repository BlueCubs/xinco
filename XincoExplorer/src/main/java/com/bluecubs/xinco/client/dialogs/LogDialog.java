 ...
 * <p>************************************************************ LogDialog.java
 *
 * <p>Created on November 22, 2006, 10:09 AM
 */
...
public class LogDialog extends AbstractDialog {
   ...
   */
  public LogDialog(
      java.awt.Frame parent, boolean modal, XincoExplorer explorer, boolean editableVersion) {
    super(parent, modal);
    ...
    actionLabel.setText(
        explorer.getResourceBundle().getString("window.loggingdetails.action") + ":");
    ...
    versionPostfixExplanation.setText(
        explorer.getResourceBundle().getString("general.version.postfix.explanation"));
  ...
  public void setToDefaults() {
    ...
    if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject() != null) {
      // For some reason
      log_index =
          ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                  .getXinco_core_logs()
                  .size()
              - 1;
      action.setText(
          ...
          ((XincoCoreLog)
              ...
              || ((XincoCoreLog)
                          ((XincoCoreData)
                              ...
                              .elementAt(log_index))
                      .getOp_code()
                  == OPCode.COMMENT_COMMENT.ordinal() + 1
              || ((XincoCoreLog)
                          ((XincoCoreData)
                                  explorer
                                      .getSession()
              ...
              || ((XincoCoreLog)
                          ((XincoCoreData)
                              ...
                              .elementAt(log_index))
                      .getOp_code()
                  == OPCode.PUBLISH_COMMENT.ordinal() + 1
              || ((XincoCoreLog)
                          ((XincoCoreData)
                                  explorer
                                      .getSession()
                              ...
                              .elementAt(log_index))
                      .getOp_code()
                  == OPCode.CHECKOUT_UNDONE.ordinal() + 1);
    }
    // Enable only for checkin
    minorChange.setEnabled(
        ((XincoCoreLog)
                    ((XincoCoreData)
                            explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                        .getXinco_core_logs()
  ...
  /**
   * Updates the version based on the minor change selection. This avoids issues with manually
   * incorrect versions.
   */
  ...
  private void continueButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_continueButtonActionPerformed
          ...
          action.getText()
              ...
              + (((XincoCoreLog)
                              ((XincoCoreData)
                                  ...
                                  .elementAt(log_index))
                          .getOp_code()
                      == OPCode.CHECKOUT.ordinal() + 1
                  ? explorer.getResourceBundle().getString("general.status.checkedout")
                  : reason.getText());
      ((XincoCoreLog)
              ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                  .getXinco_core_logs()
                  .elementAt(log_index))
          .setOp_description(text);
      ...
      try {
        ((XincoCoreLog)
                ((XincoCoreData)
                    ...
                    .elementAt(log_index))
            .getVersion()
            .setVersion_high(Integer.parseInt(text));
      } catch (Exception nfe) {
        ((XincoCoreLog)
                ((XincoCoreData)
                        explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
      ...
      try {
        ((XincoCoreLog)
                ((XincoCoreData)
                    ...
                    .elementAt(log_index))
            .getVersion()
            .setVersion_mid(Integer.parseInt(text));
      } catch (Exception nfe) {
        ((XincoCoreLog)
                ((XincoCoreData)
                        explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
      ...
      try {
        ((XincoCoreLog)
                ((XincoCoreData)
                    ...
                    .elementAt(log_index))
            .getVersion()
            .setVersion_low(Integer.parseInt(text));
      } catch (Exception nfe) {
        ((XincoCoreLog)
                ((XincoCoreData)
                        explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
  ...
  private void minorChangeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_minorChangeActionPerformed
    updateVersion();
