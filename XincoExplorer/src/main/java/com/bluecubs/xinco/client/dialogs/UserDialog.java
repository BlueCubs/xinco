 ...
 * <p>************************************************************ UserDialog.java
 *
 * <p>Created on September 25, 2006, 6:16 PM
 */
...
public class UserDialog extends AbstractDialog {
  ...
  private void initialize() {
    ...
    this.verificationLabel.setText(
        explorer.getResourceBundle().getString("general.verifypassword") + ":");
    this.name.setText("" + explorer.getSession().getUser().getFirstname());
    this.nameLabel.setText(
        explorer.getResourceBundle().getString("window.userinfo.firstname") + ":");
    this.lastname.setText("" + explorer.getSession().getUser().getName());
    this.lastnameLabel.setText(
        explorer.getResourceBundle().getString("window.userinfo.lastname") + ":");
  ...
  private void saveActionPerformed(
    ...
    if ((new String(password.getPassword())).equals(new String(verification.getPassword()))) {
      try {
        if (this.isAged
          ...
          this.explorer
              ...
              .getXinco()
              .checkXincoCoreUserNewPassword(
                  new String(password.getPassword()), this.explorer.getSession().getUser(), null);
        ...
        explorer
            .getUser()
            .setXinco_core_groups(explorer.getSession().getUser().getXinco_core_groups());
        ...
        explorer
            ...
            .setUser(
                explorer
                    .getSession()
                    .getXinco()
                    .setXincoCoreUser(explorer.getUser(), explorer.getSession().getUser()));
        ...
        explorer.jLabelInternalFrameInformationText.setText(
            explorer.getResourceBundle().getString("window.userinfo.updatesuccess"));
        setVisible(false);
      } catch (Exception ue) {
        JOptionPane.showMessageDialog(
            this,
            explorer.getResourceBundle().getString("window.userinfo.updatefailed")
                + " "
      ...
      JOptionPane.showMessageDialog(
          this,
          explorer.getResourceBundle().getString("window.userinfo.passwordmismatch"),
          explorer.getResourceBundle().getString("general.error"),
          JOptionPane.WARNING_MESSAGE);
    }
