 ...
 * <p>Name: XincoJTree
 *
 * <p>Description: Xinco JTree
 *
 * <p>Original Author: Javier A. Ortiz Date: May 18, 2010, 9:34 AM
 *
 * <p>Modifications:
 *
 * <p>Who? When? What?
...
public final class XincoJTree extends JTree {
          ...
          public void valueChanged(javax.swing.event.TreeSelectionEvent e) {
            getExplorer()
                ...
                .setTitle(
                    getExplorer()
                        .getResourceBundle()
                        .getString("message.explorer.verifyingcredentials"));
            ...
            if (node.getUserObject().getClass() == XincoCoreNode.class) {
              tempAce =
                  XincoCoreACEClient.checkAccess(
                      getExplorer().getSession().getUser(),
            ...
            if (tempAce.isWrite_permission()) {
              ...
              ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                  .itemSetEnable(4, true);
              ((XincoMenuRepository) getExplorer().getJMenuRepository()).itemSetEnable(7, true);
              ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                  .itemSetEnable(7, true);
            }
            ...
            if (node.getUserObject().getClass() == XincoCoreNode.class) {
              if (tempAce.isWrite_permission()) {
                ...
                ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                    .itemSetEnable(1, true);
                ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                    .itemSetEnable(2, true);
                ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                    .itemSetEnable(3, true);
            ...
            if (node.getUserObject().getClass() == XincoCoreData.class) {
              ...
              if (((XincoCoreData) node.getUserObject()).getXinco_core_data_type().getId() == 1) {
                ...
                ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                    .itemSetEnable(17, true);
                if (tempAce.isRead_permission()) {
                  if (((XincoCoreData) node.getUserObject()).getStatus_number()
                      != XincoDataStatus.ARCHIVED.ordinal() + 1) {
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(5, true);
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(11, true);
                    ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                        .itemSetEnable(5, true);
                ...
                if (tempAce.isWrite_permission()) {
                  if (((XincoCoreData) node.getUserObject()).getStatus_number()
                      == XincoDataStatus.OPEN.ordinal() + 1) {
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(12, true);
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(13, false);
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(14, false);
                    ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                        .itemSetEnable(12, true);
                    ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                        .itemSetEnable(13, false);
                  ...
                  if (((XincoCoreData) node.getUserObject()).getStatus_number()
                      == XincoDataStatus.CHECKED_OUT.ordinal() + 1) {
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(12, false);
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(13, true);
                    ((XincoMenuRepository) getExplorer().getJMenuRepository())
                        .itemSetEnable(14, true);
                    ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                        .itemSetEnable(12, false);
                    ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                        .itemSetEnable(13, true);
              ...
              if (tempAce.isAdmin_permission()) {
                if ((((XincoCoreData) node.getUserObject()).getStatus_number()
                    ...
                    && (((XincoCoreData) node.getUserObject()).getStatus_number()
                        != XincoDataStatus.CHECKED_OUT.ordinal() + 1)) {
                  ((XincoMenuRepository) getExplorer().getJMenuRepository())
                      .itemSetEnable(15, true);
                  ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                      .itemSetEnable(15, true);
                }
                if ((((XincoCoreData) node.getUserObject()).getStatus_number()
                        != XincoDataStatus.LOCKED.ordinal() + 1)
                    && (((XincoCoreData) node.getUserObject()).getStatus_number()
                        != XincoDataStatus.ARCHIVED.ordinal() + 1)) {
                  ((XincoMenuRepository) getExplorer().getJMenuRepository())
                      .itemSetEnable(16, true);
                  ((XincoPopUpMenuRepository) getExplorer().getJPopupMenuRepository())
                      .itemSetEnable(16, true);
                }
              }
                ...
                try {
                  XincoCoreNode xnode =
                      getExplorer()
                          ...
                          .getXinco()
                          .getXincoCoreNode(
                              (XincoCoreNode) node.getUserObject(),
                              getExplorer().getSession().getUser());
                  ...
                  if (xnode != null) {
                    getExplorer()
                        ...
                        .assignObject2TreeNode(
                            node,
                            xnode,
                            getExplorer().getSession().getXinco(),
                            getExplorer().getSession().getUser(),
                            2);
                  } else {
                ...
                getExplorer()
                    .setXdata(
                        getExplorer()
                            ...
                            .getXinco()
                            .getXincoCoreData(
                                (XincoCoreData) node.getUserObject(),
                                getExplorer().getSession().getUser()));
            ...
            if (node.getUserObject().getClass() == XincoCoreNode.class) {
              DefaultTableModel dtm =
                  (DefaultTableModel) getExplorer().getJTableRepository().getModel();
              ...
              rdata[1] =
                  ((XincoCoreNode) node.getUserObject()).getXinco_core_language().getDesignation()
                      + " ("
              ...
              if (((XincoCoreNode) node.getUserObject()).getStatus_number() == 2) {
                rdata[1] =
                    getExplorer().getResourceBundle().getString("general.status.locked") + " (-)";
              }
              if (((XincoCoreNode) node.getUserObject()).getStatus_number() == 3) {
                rdata[1] =
                    getExplorer().getResourceBundle().getString("general.status.archived")
                        + " (->)";
              }
              dtm.addRow(rdata);
            }
            if (node.getUserObject().getClass() == XincoCoreData.class) {
              ...
              if (getExplorer().getXdata() != null) {
                ...
                rdata[0] = getExplorer().getResourceBundle().getString("general.language");
                rdata[1] =
                    getExplorer().getXdata().getXinco_core_language().getDesignation()
                        + " ("
              ...
              rdata[1] =
                  getExplorer()
                          .getResourceBundle()
                          .getString(
                              getExplorer().getXdata().getXinco_core_data_type().getDesignation())
                      + " ("
                      + getExplorer()
                          .getResourceBundle()
                          .getString(
              ...
              rdata[0] = getExplorer().getResourceBundle().getString("general.status");
              rdata[1] = "";
              if (getExplorer().getXdata().getStatus_number()
                  == XincoDataStatus.OPEN.ordinal() + 1) {
                rdata[1] = getExplorer().getResourceBundle().getString("general.status.open") + "";
              }
              if (getExplorer().getXdata().getStatus_number()
              ...
              if (getExplorer().getXdata().getStatus_number()
                  == XincoDataStatus.CHECKED_OUT.ordinal() + 1) {
                rdata[1] =
                    getExplorer().getResourceBundle().getString("general.status.checkedout")
                        + " (X)";
              }
              if (getExplorer().getXdata().getStatus_number()
                  == XincoDataStatus.PUBLISHED.ordinal() + 1) {
                rdata[1] =
                    getExplorer().getResourceBundle().getString("general.status.published")
                        + " (WWW)";
              }
              dtm.addRow(rdata);
              rdata[0] = "";
              ...
              dtm.addRow(rdata);
              rdata[0] =
                  getExplorer().getResourceBundle().getString("general.typespecificattributes");
              rdata[1] = "";
              dtm.addRow(rdata);
              ...
              if (getExplorer().getXdata().getXinco_add_attributes().size() > 0) {
                for (i = 0; i < getExplorer().getXdata().getXinco_add_attributes().size(); i++) {
                  if (i
                    ...
                    if (((XincoCoreDataTypeAttribute)
                      ...
                      Date time =
                          ((XincoAddAttribute)
                                  getExplorer().getXdata().getXinco_add_attributes().elementAt(i))
                              .getAttrib_datetime()
                              .getTime();
                ...
                rdata[1] =
                    getExplorer().getResourceBundle().getString("error.content.sufficientrights");
                dtm.addRow(rdata);
              }
              rdata[0] = "";
              rdata[1] = "";
              ...
              for (i = getExplorer().getXdata().getXinco_core_logs().size() - 1; i >= 0; i--) {
                if (((XincoCoreLog) getExplorer().getXdata().getXinco_core_logs().elementAt(i))
                        .getOp_datetime()
                    != null) {
                  try {
                    ...
                    cal =
                        (Calendar)
                            ((XincoCoreLog)
                                    getExplorer().getXdata().getXinco_core_logs().elementAt(i))
                                .getOp_datetime()
                                .clone();
                    realcal =
                        (((XincoCoreLog) getExplorer().getXdata().getXinco_core_logs().elementAt(i))
                            .getOp_datetime());
                    cal.add(
                ...
                try {
                  rdata[1] =
                      getExplorer().getResourceBundle().getString("general.version")
                          + " "
                          + ((XincoCoreLog)
                                  getExplorer().getXdata().getXinco_core_logs().elementAt(i))
                              .getVersion()
  ...
  private boolean isLeaf() {
    return getExplorer().getSession().getCurrentTreeNodeSelection().getUserObject().getClass()
        == XincoCoreData.class;
  }
