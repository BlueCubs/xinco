 ...
 *
 * <p>Name: XincoProgressBar
 *
 * <p>Description: XincoProgressBar
 *
 ...
 * <p>Who? When? What?
 *
 * <p>************************************************************ XincoProgressBar.java
 *
 * <p>Created on December 19, 2006, 4:16 PM
 */
...
public class XincoProgressBar extends JFrame {
  ...
  private void setProgress(int p) {
    ...
    if (p == progress.getMaximum()) this.setVisible(false);
  }
}
