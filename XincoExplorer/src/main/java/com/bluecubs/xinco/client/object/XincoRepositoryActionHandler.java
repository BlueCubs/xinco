 ...
 *
 * <p>Name: XincoActionHandler
 *
 * <p>Description: XincoActionHandler
 *
 * <p>Original Author: Javier A. Ortiz Date: February 23, 2010, 3:44 PM
 *
 * <p>Modifications:
 *
 * <p>Who? When? What?
...
public class XincoRepositoryActionHandler {
  ...
  public class Refresh extends AbstractAction {
    ...
    public Refresh(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
  ...
  public class AddFolder extends AbstractAction {
    ...
    public AddFolder(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (explorer.getSession().getCurrentTreeNodeSelection() != null) {
        if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject().getClass()
          ...
          // set node attributes
          ((XincoCoreNode) newnode.getUserObject())
              .setXinco_core_node_id(
                  ((XincoCoreNode)
                          explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                      .getId());
          ((XincoCoreNode) newnode.getUserObject())
              .setDesignation(xerb.getString("general.newfolder"));
          ((XincoCoreNode) newnode.getUserObject())
              .setXinco_core_language(
                  (XincoCoreLanguage) explorer.getSession().getServerLanguages().elementAt(0));
          ...
          explorer
              ...
              .insertNodeInto(
                  newnode,
                  explorer.getSession().getCurrentTreeNodeSelection(),
                  explorer.getSession().getCurrentTreeNodeSelection().getChildCount());
          ...
          explorer
              ...
              .getXincoClientRepository()
              .treemodel
              .reload(explorer.getSession().getCurrentTreeNodeSelection());
          explorer
              .getSession()
              .getXincoClientRepository()
              .treemodel
              .nodeChanged(explorer.getSession().getCurrentTreeNodeSelection());
        }
      }
    }
  }
  ...
  public class AddData extends AbstractAction {
    ...
    public AddData(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class AddDataStructure extends AbstractAction {
    ...
    public AddDataStructure(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class EditFolderData extends AbstractAction {
    ...
    public EditFolderData(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class ViewEditDataAttributes extends AbstractAction {
    ...
    public ViewEditDataAttributes(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class EditACL extends AbstractAction {
    ...
    public EditACL(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class MoveToClipboard extends AbstractAction {
    ...
    public MoveToClipboard(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class InsertFolderData extends AbstractAction {
    ...
    public InsertFolderData(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class ViewURL extends AbstractAction {
    ...
    public ViewURL(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class EmailContact extends AbstractAction {
    ...
    public EmailContact(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class DownloadFile extends AbstractAction {
    ...
    public DownloadFile(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class CheckoutFile extends AbstractAction {
    ...
    public CheckoutFile(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class UndoCheckoutFile extends AbstractAction {
    ...
    public UndoCheckoutFile(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class CheckinFile extends AbstractAction {
    ...
    public CheckinFile(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class PublishData extends AbstractAction {
    ...
    public PublishData(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class LockData extends AbstractAction {
    ...
    public LockData(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class DownloadRevision extends AbstractAction {
    ...
    public DownloadRevision(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class CommentData extends AbstractAction {
    ...
    public CommentData(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public class AuditSettings extends AbstractAction {
    ...
    public AuditSettings(String text, Icon icon, String desc, KeyStroke key) {
      super(text, icon);
      putValue(SHORT_DESCRIPTION, desc);
      putValue(ACCELERATOR_KEY, key);
    }
  ...
  public void moveToClipboard() {
    ...
    for (i = 0; i < explorer.getJTreeRepository().getSelectionCount(); i++) {
      explorer
          .getSession()
          .getClipboardTreeNodeSelection()
          .addElement(tps[i].getLastPathComponent());
    }
  }
  ...
  public void insertNode(boolean dragNdrop) {
    if (((explorer.getSession().getCurrentTreeNodeSelection().getUserObject().getClass()
                == XincoCoreNode.class)
            && !dragNdrop)
        || ((explorer.getJTreeRepository().getPreviousTreeNodeSelection().getUserObject().getClass()
                    == XincoCoreNode.class)
                && dragNdrop)
      ...
      for (i = 0; i < cb_size; i++) {
        tempNode =
            (XincoMutableTreeNode)
                explorer.getSession().getClipboardTreeNodeSelection().elementAt(0);
        if ((explorer.getSession().getCurrentTreeNodeSelection() != tempNode && !dragNdrop)
            || dragNdrop) {
          // paste node
          if (tempNode.getUserObject().getClass() == XincoCoreNode.class) {
            ...
            try {
              ...
              // For some reason removing the node from parent changes the xinco core node id to was
              // it was. Modify node afterwards.
              if (!dragNdrop
                  && (explorer.getSession().getCurrentTreeNodeSelection().getUserObject().getClass()
                      == XincoCoreNode.class)) {
                ((XincoCoreNode) tempNode.getUserObject())
                    .setXinco_core_node_id(
                        ((XincoCoreNode)
                                explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                            .getId());
                ...
                ((XincoCoreNode) tempNode.getUserObject())
                    .setXinco_core_node_id(
                        ((XincoCoreNode)
                                explorer.getJTreeRepository().getTargetTreeNode().getUserObject())
                            .getId());
              }
              if (!dragNdrop) {
                explorer
          ...
          if (tempNode.getUserObject().getClass() == XincoCoreData.class) {
            ...
            if (!dragNdrop) {
              ((XincoCoreData) tempNode.getUserObject())
                  .setXinco_core_node_id(
                      ((XincoCoreNode)
                              explorer.getSession().getCurrentTreeNodeSelection().getUserObject())
                          .getId());
            ...
            try {
              ...
              if (dragNdrop) {
                // For some reason removing the node from parent changes the xinco core node id to
                // was it was. Modify node afterwards.
                ((XincoCoreData) tempNode.getUserObject())
                    .setXinco_core_node_id(
                        ((XincoCoreNode)
                                explorer.getJTreeRepository().getTargetTreeNode().getUserObject())
              ...
              if (explorer
                      ...
                      .getXinco()
                      .setXincoCoreData(
                          (XincoCoreData) tempNode.getUserObject(), explorer.getSession().getUser())
                  == null) {
                throw new XincoException(xerb.getString("error.nowritepermission"));
              }
              // insert log
              try {
                ...
                if (!dragNdrop) {
                  newlog.setOp_description(
                      xerb.getString("menu.edit.movedtofolder")
                          + " "
                          + ((XincoCoreNode)
                                  explorer
                                      .getSession()
                ...
                newlog.setVersion(
                    ((XincoCoreLog) oldlogs.elementAt(oldlogs.size() - 1)).getVersion());
                explorer
                    .getSession()
                    .getXinco()
                    .setXincoCoreLog(newlog, explorer.getSession().getUser());
              } catch (Exception loge) {
              }
              // update transaction info
              explorer.jLabelInternalFrameInformationText.setText(
                  xerb.getString("menu.edit.movedatasuccess"));
            } catch (Exception rmie) {
