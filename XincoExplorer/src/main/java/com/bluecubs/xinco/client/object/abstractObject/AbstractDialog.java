 ...
 *
 * <p>Name: AbstractDialog
 *
 * <p>Description: Abstract class with common methods for Dialogs within Xinco Explorer.
 *
...
public abstract class AbstractDialog extends javax.swing.JDialog {
  ...
  /**
   * Get a HashMap<JTextField, String> containing the fields of this Dialog and their default
   * values.
   *
   * @return HashMap<JTextField, String> containing the fields of this Dialog and their default
   *     values
   */
  ...
  /**
   * Get a HashMap<JTextArea, String> containing the fields of this Dialog and their default values.
   *
   * @return HashMap<JTextArea, String> containing the fields of this Dialog and their default
   *     values
   */
  ...
  /**
   * Get a HashMap<JTable, DefaultTableModel> containing the fields of this Dialog and their default
   * values.
   *
   * @return HashMap<JTable, DefaultTableModel> containing the fields of this Dialog and their
   *     default values
   */
