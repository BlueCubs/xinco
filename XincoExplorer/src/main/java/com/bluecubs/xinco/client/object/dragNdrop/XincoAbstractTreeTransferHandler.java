 ...
 *
 * <p>Name: XincoAbstractTreeTransferHandler
 *
 * <p>Description: XincoAbstractTreeTransferHandler
 *
 * <p>Original Author: Javier A. Ortiz Date: May 18, 2010, 2:21 PM
 *
 * <p>Modifications:
 *
 * <p>Who? When? What?
 ...
 */
public abstract class XincoAbstractTreeTransferHandler
    ...
    if (dsde.getDropSuccess()
      ...
      if (draggedNode.getUserObject().getClass() == XincoCoreNode.class) {
        temp_ace =
            XincoCoreACEClient.checkAccess(
                getTree().getExplorer().getSession().getUser(),
      ...
      if (temp_ace.isWrite_permission()) {
        getTree()
            .getExplorer()
            .getSession()
            .setCurrentTreeNodeSelection((XincoMutableTreeNode) draggedNodeParent);
        ...
        getTree()
            .getExplorer()
            .jLabelInternalFrameInformationText
            .setText(
                getTree()
                    .getExplorer()
                    .getResourceBundle()
                    .getString("menu.edit.movefoldersuccess"));
      }
    }
  }
    ...
    if (path != null) {
      ...
      if (drawImage) {
        ...
        getTree()
            ...
            .jLabelInternalFrameInformationText
            .setText(
                getTree().getExplorer().getResourceBundle().getString("menu.edit.movemessage"));
      ...
      dragSource.startDrag(
          ...
          image,
          new Point(0, 0),
          new XincoTransferableNode(draggedNode),
          this);
    }
  }
  ...
  public final void drop(DropTargetDropEvent dtde) {
    try {
      ...
      Point pt = dtde.getLocation();
      if (transferable.isDataFlavorSupported(XincoTransferableNode.NODE_FLAVOR)
          && canPerformAction(getTree(), draggedNode, action, pt)) {
        TreePath pathTarget = getTree().getPathForLocation(pt.x, pt.y);
        DefaultMutableTreeNode node =
            (DefaultMutableTreeNode)
                transferable.getTransferData(XincoTransferableNode.NODE_FLAVOR);
