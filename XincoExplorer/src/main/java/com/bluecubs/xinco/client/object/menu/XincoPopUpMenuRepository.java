 ...
 *
 * <p>Name: XincoMenuPopUpRepository
 *
 * <p>Description: XincoMenuPopUpRepository
 *
 ...
 * <p>Who? When? What?
 *
 * <p>************************************************************ XincoMenuPopUpRepository.java
 *
 * <p>Created on December 11, 2006, 2:19 PM
 */
...
public class XincoPopUpMenuRepository extends JPopupMenu {
  ...
  public JMenuItem AddData = null,
      AddDataStructure = null,
      ViewURL = null,
      EmailContact = null,
      EditFolderData = null,
      CheckoutData = null,
      UndoCheckoutData = null,
      CheckinData = null,
      PublishData = null,
      LockData = null,
      ...
      Refresh = null,
      AddFolder = null,
      ViewEditAddAttributes = null,
      EditFolderDataACL = null,
      MoveFolderData = null,
      InsertFolderData = null,
      ViewData = null,
      CommentData = null;
  ...
  public XincoPopUpMenuRepository(final XincoExplorer explorer) {
    ...
    Component[] components =
        ((XincoMenuRepository) this.explorer.getJMenuRepository()).getMenuComponents();
