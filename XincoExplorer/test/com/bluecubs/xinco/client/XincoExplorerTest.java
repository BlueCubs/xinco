...
public class XincoExplorerTest extends TestCase {
  ...
  public void testConfigFileVersioning() {
    ...
    xincoClientConfig.addElement("javax.swing.plaf.metal.MetalLookAndFeel");
    //add locale
    xincoClientConfig.addElement(Locale.getDefault());
    //add version
    xincoClientConfig.addElement(XincoExplorer.CONFIG_FILE_VERSION + 1);
    try {
      try (java.io.FileOutputStream fout = new java.io.FileOutputStream(System.getProperty("user.home")
          + System.getProperty("file.separator") + "xincoClientConfig.dat"); java.io.ObjectOutputStream os = new java.io.ObjectOutputStream(fout)) {
