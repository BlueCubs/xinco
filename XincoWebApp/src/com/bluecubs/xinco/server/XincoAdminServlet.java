...
{
  private static final long serialVersionUID = 5_142_869_078_493_035_856L;
          ...
          throws ServletException, IOException
  {
    ...
    rb = getBundle("com.bluecubs.xinco.messages.XincoMessages", loc);
    settings = getBundle("com.bluecubs.xinco.settings.settings", loc);
    XincoDBManager dbm;
    ...
    int current_user_selection;
    int current_group_selection;
    int current_datatype_selection;
    int status;
    ...
    try (PrintWriter out = response.getWriter())
    {
      ...
      if (session.getAttribute("XincoAdminServlet.status") == null)
      {
        ...
        session.setAttribute("XincoAdminServlet.current_datatype_selection", current_datatype_selection);
      }
      else
      {
        ...
        current_user_selection = ((Integer) session.getAttribute("XincoAdminServlet.current_user_selection"));
        current_group_selection = ((Integer) session.getAttribute("XincoAdminServlet.current_group_selection"));
        current_datatype_selection = ((Integer) session.getAttribute("XincoAdminServlet.current_datatype_selection"));
        if (status == 0)
        {
          current_location = "MainLogin";
          session.setAttribute("XincoAdminServlet.current_location", current_location);
        ...
        try
        {
          ...
          catch (XincoException loginex)
          {
            ...
            if (rs.next())
            {
              ...
              long attempts = parseLong(settings.getString("password.attempts"));
      ...
      if (request.getParameter("DialogAdminUsersLock") != null)
      {
        ...
        if (!(parseInt(request.getParameter("DialogAdminUsersLock")) == 1))
        {
          try
          {
            i = parseInt(request.getParameter("DialogAdminUsersLock"));
          ...
          catch (XincoException | NumberFormatException e)
          {
      ...
      if (request.getParameter("DialogAdminUsersUnlock") != null)
      {
        try
        {
          i = parseInt(request.getParameter("DialogAdminUsersUnlock"));
          temp_user = new XincoCoreUserServer(i, dbm);
      ...
      if (request.getParameter("DialogAdminUsersResetPW") != null)
      {
        try
        {
          i = parseInt(request.getParameter("DialogAdminUsersResetPW"));
          temp_user = new XincoCoreUserServer(i, dbm);
      ...
      if (request.getParameter("DialogNewUserSubmit") != null)
      {
        try
        {
          ...
          temp_user = new XincoCoreUserServer(0,
                  ...
                  new Timestamp(currentTimeMillis()), dbm);
      ...
      if (request.getParameter("DialogNewGroupSubmit") != null)
      {
        try
        {
          temp_group = new XincoCoreGroupServer(0,
                  request.getParameter("DialogNewGroupName"), 1);
      ...
      if (request.getParameter("DialogAdminGroupsSelect") != null)
      {
        current_group_selection
                = parseInt(request.getParameter("DialogAdminGroupsSelect"));
        session.setAttribute("XincoAdminServlet.current_group_selection",
                current_group_selection);
        current_location = "GroupAdminSingle";
        session.setAttribute("XincoAdminServlet.current_location",
                current_location);
        current_location_desc = rb.getString("message.location.desc.specificgroupadmin");
        session.setAttribute("XincoAdminServlet.current_location_desc",
      ...
      if (request.getParameter("DialogEditGroupRemoveUser") != null)
      {
        ...
        if (!(((current_group_selection == 1)
                && (parseInt(request.getParameter("DialogEditGroupRemoveUser")) == 1))
                || (current_group_selection == 2)))
        {
          try
          {
            ...
            {
              stmt.executeUpdate("DELETE FROM xinco_core_user_has_xinco_core_group WHERE xinco_core_user_id="
                      + parseInt(request.getParameter("DialogEditGroupRemoveUser"))
                      + " AND xinco_core_group_id=" + current_group_selection);
            }
            dbm.con.commit();
          }
          catch (NumberFormatException | SQLException e)
      ...
      if (request.getParameter("DialogEditGroupAddUser") != null)
      {
        try
        {
          try (Statement stmt = dbm.con.createStatement())
          {
            stmt.executeUpdate("INSERT INTO xinco_core_user_has_xinco_core_group VALUES ("
                    + parseInt(request.getParameter("DialogEditGroupAddUser")) + ", "
                    + current_group_selection + ", " + "1)");
          }
          dbm.con.commit();
        }
        catch (NumberFormatException | SQLException e)
      ...
      if (request.getParameter("DialogEditUserProfileSubmit") != null)
      {
        try
        {
          temp_user = new XincoCoreUserServer(parseInt(request.getParameter("DialogEditUserProfileID")), dbm);
      ...
      if (request.getParameter("DialogAdminLanguagesDelete") != null)
      {
        try
        {
          temp_language = new XincoCoreLanguageServer(parseInt(request
                  .getParameter("DialogAdminLanguagesDelete")), dbm);
          deleteFromDB(temp_language, dbm, login_user.getId());
        }
        catch (XincoException | NumberFormatException e)
        {
        }
      ...
      if (request.getParameter("DialogAdminDataTypeSelect") != null)
      {
        current_datatype_selection
                = parseInt(request.getParameter("DialogAdminDataTypeSelect"));
        session.setAttribute("XincoAdminServlet.current_datatype_selection",
                current_datatype_selection);
      ...
      if (request.getParameter("DialogNewAttributeSubmit") != null)
      {
        ...
        {
          temp_attribute
                  = new XincoCoreDataTypeAttributeServer(current_datatype_selection,
                          parseInt(request.getParameter("DialogNewAttributeAttributeId")),
                          request.getParameter("DialogNewAttributeDesignation"),
                          request.getParameter("DialogNewAttributeDataType"),
                          parseInt(request.getParameter("DialogNewAttributeSize")));
      ...
      if (request.getParameter("DialogEditAttributesRemoveAttributeId") != null)
      {
        try
        {
          temp_attribute = new XincoCoreDataTypeAttributeServer(current_datatype_selection,
                  parseInt(request.getParameter("DialogEditAttributesRemoveAttributeId")), dbm);
          deleteFromDB(temp_attribute, dbm, login_user.getId());
        }
        catch (XincoException | NumberFormatException e)
        {
        }
      ...
      if (request.getParameter("changePassword") != null)
      {
        ...
        try
        {
          ...
          sql = "select id from xinco_core_user where username='"
                  + request.getParameter("user").substring(0, request.getParameter("user").length() - 1) + "'";
      ...
      switch (status)
      {
        ...
        default:
          ...
          } if (current_location.compareTo("UserAdmin") == 0)
          {
            ...
            out.println("</tr>");
            Vector allusers = getXincoCoreUsers(dbm);
          ...
          } if (current_location.compareTo("GroupAdmin") == 0)
          {
            ...
            out.println("<td class=\"bigtext\">&nbsp;</td>");
            out.println("</tr>");
            Vector allgroups = getXincoCoreGroups(dbm);
          ...
          } if (current_location.compareTo("LanguageAdmin") == 0)
          {
            ...
            out.println("<td class=\"bigtext\">&nbsp;</td>");
            out.println("</tr>");
            Vector alllanguages = getXincoCoreLanguages(dbm);
            boolean is_used;
            for (i = 0; i < alllanguages.size(); i++)
            {
              ...
              is_used = isLanguageUsed((XincoCoreLanguageServer) alllanguages.elementAt(i), dbm);
              if (!is_used)
              {
          ...
          } if (current_location.compareTo("AttributesAdmin") == 0)
          {
            ...
            out.println("<td class=\"bigtext\">&nbsp;</td>");
            out.println("</tr>");
            Vector alldatatypes = getXincoCoreDataTypes(dbm);
          ...
          } if (current_location.compareTo("RebuildIndex") == 0)
          {
            ...
            try
            {
              ...
              boolean index_directory_deleted;
              ...
              out.println("</tr>");
              XincoCoreDataServer xdata_temp;
              ...
              try (Statement stmt = dbm.con.createStatement())
              {
                ...
                while (rs.next())
                {
                  ...
                  index_result = indexXincoCoreData(xdata_temp, true, dbm);
                  out.println("<tr>");
              ...
              //optimize index
              index_result = optimizeIndex(dbm);
              out.println("<tr>");
