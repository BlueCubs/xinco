...
@NamedQueries({
    ...
    @NamedQuery(name = "XincoParameter.findByValue", query = "SELECT x FROM XincoParameter x WHERE x.value = :value")})
public class XincoParameter implements Serializable {
    ...
    public XincoParameter(XincoParameterPK xincoParameterPK, String name, String valueType, String value) {
        this.xincoParameterPK = xincoParameterPK;
        this.name = name;
    ...
    public XincoParameter(int xincoActionId) {
        this.xincoParameterPK = new XincoParameterPK(xincoActionId);
    }
    ...
    public String toString() {
        return "com.bluecubs.xinco.workflow.persistence.XincoParameter[xincoParameterPK=" + xincoParameterPK + "]";
    }
