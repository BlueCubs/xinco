...
INSERT INTO xinco_setting (id, description, int_value, string_value, bool_value, long_value) VALUES(30,'general.setting.email.host',null,'smtp.gmail.com', null,null);
INSERT INTO xinco_setting (id, description, int_value, string_value, bool_value, long_value) VALUES(31,'general.setting.email.user',null,'info@bluecubs.com', null,null); 
INSERT INTO xinco_setting (id, description, int_value, string_value, bool_value, long_value) VALUES(32,'general.setting.email.password',null,'password', null,null); 
INSERT INTO xinco_setting (id, description, int_value, string_value, bool_value, long_value) VALUES(33,'general.setting.email.port',null,'25', null,null); 

INSERT INTO xinco_setting (id, description, int_value, string_value, bool_value, long_value) VALUES(34,'general.setting.index.lock',null,null,false,null); 
