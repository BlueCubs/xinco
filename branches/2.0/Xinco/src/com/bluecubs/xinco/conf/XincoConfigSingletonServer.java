...
public class XincoConfigSingletonServer {
    ...
    public void init(XincoSettingServer xss){
        try{
            ...
            getIndexFileTypesExt().add(xss.getSetting("xinco/IndexNoIndex").getStringValue());
            setAllowOutsideLinks(xss.getSetting("setting.allowoutsidelinks").isBoolValue());
        } catch (Exception ex) {
            //Default values
