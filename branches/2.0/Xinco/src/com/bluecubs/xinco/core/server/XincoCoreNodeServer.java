    ...
    public int write2DB(XincoDBManager DBM) throws XincoException {
        ...
        try {
            ...
            if (getId() > 0) {
                ...
                stmt.executeUpdate("UPDATE xinco_core_node SET xinco_core_node_id=" + xcnid + ", xinco_core_language_id=" + getXincoCoreLanguage().getId() + ", designation='" + getDesignation().replaceAll("'","\\\\'") + "', status_number=" + getStatusNumber() + " WHERE id=" + getId());
                stmt.close();
            } else {
                ...
                stmt.executeUpdate("INSERT INTO xinco_core_node VALUES (" + getId() + ", " + getXincoCoreNodeId() + ", " + getXincoCoreLanguage().getId() + ", '" + getDesignation().replaceAll("'","\\\\'") + "', " + getStatusNumber() + ")");
                stmt.close();
            }
