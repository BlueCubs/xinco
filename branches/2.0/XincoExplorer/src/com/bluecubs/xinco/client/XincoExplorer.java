...
public class XincoExplorer extends JFrame {
   ...
   private void updateSettings() {
        ...
        try {
            ...
            if (getSettings().getSetting("general.setting.enable.developermode").isBoolValue()) {
                ex.printStackTrace();
            }
        }
        ...
        if (jMenuItemAboutAboutXinco == null) {
            ...
            jMenuItemAboutAboutXinco.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    message_string = message_string + xerb.getString("window.aboutxinco.clientversion") + ": " + xincoClientVersion.getVersionHigh() + "." + xincoClientVersion.getVersionMid() + "." + xincoClientVersion.getVersionLow() + xincoClientVersion.getVersionPostfix() + "\n";
        ...
        if (jTreeRepository == null) {
            ...
            jTreeRepository.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
                ...
                public void valueChanged(javax.swing.event.TreeSelectionEvent e) {
                    ...
                    xincoClientSession.setCurrentTreeNodeSelection(node);
                    // get ace
                    if (node.getUserObject().getClass() ==
                            XincoCoreNode.class) {
                        temp_ace = XincoCoreACEClient.checkAccess(
                                xincoClientSession.getUser(), ((XincoCoreNode) node.getUserObject()).getXinco_core_acl());
                    }
                    if (node.getUserObject().getClass() ==
                            XincoCoreData.class) {
                        temp_ace = XincoCoreACEClient.checkAccess(
                                xincoClientSession.getUser(), ((XincoCoreData) node.getUserObject()).getXinco_core_acl());
                    }
                    // intelligent menu
                    // reset menus
                    getJPopupMenuRepository();
                    ...
                    if (node.getUserObject().getClass() ==
                        ...
                        if (temp_ace.isWrite_permission()) {
                            ...
                            ((XincoPopUpMenuRepository) jPopupMenuRepository).itemSetEnable(3,
                                    true);
                            if (xincoClientSession.getClipboardTreeNodeSelection().size() >
                                    0) {
                    ...
                    if (node.getUserObject().getClass() ==
                            XincoCoreData.class) {
                        // file = 1
                        if (((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getId() ==
                                1) {
                            ...
                            if (temp_ace.isReadPermission()) {
                                if (((XincoCoreData) node.getUserObject()).getStatusNumber() !=
                                        3) {
                        ...
                        if (temp_ace.isAdmin_permission()) {
                            if ((((XincoCoreData) node.getUserObject()).getStatusNumber() !=
                                    3) &&
                                    (((XincoCoreData) node.getUserObject()).getStatusNumber() !=
                                    4)) {
                    ...
                    if (node.getUserObject().getClass() ==
                        ...
                        if ((((XincoCoreNode) node.getUserObject()).getXinco_core_nodes().size() ==
                                ...
                                0)) {
                            try {
                                XincoCoreNode xnode = xincoClientSession.getXinco().getXincoCoreNode((XincoCoreNode) node.getUserObject(), xincoClientSession.getUser());

                                if (xnode !=
                                        null) {
                                    xincoClientSession.getXincoClientRepository().assignObject2TreeNode(node,
                    ...
                    if (node.getUserObject().getClass() ==
                            XincoCoreData.class) {
                        try {
                            xdata = xincoClientSession.getXinco().getXincoCoreData((XincoCoreData) node.getUserObject(), xincoClientSession.getUser());
                            if (xdata != null) {
                                node.setUserObject(xdata);
                                xincoClientSession.getXincoClientRepository().treemodel.nodeChanged(node);
                            } else {
                                JOptionPane.showMessageDialog(XincoExplorer.this,
                    ...
                    if (node.getUserObject().getClass() ==
                        ...
                        dtm.addRow(rdata);
                        rdata[0] = xerb.getString("general.language");
                        rdata[1] = ((XincoCoreData) node.getUserObject()).getXincoCoreLanguage().getDesignation() +
                                " (" +
                                ((XincoCoreData) node.getUserObject()).getXincoCoreLanguage().getSign() +
                                ")";
                        dtm.addRow(rdata);
                        rdata[0] = xerb.getString("general.datatype");
                        rdata[1] = ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getDesignation() +
                                " (" +
                                ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getDescription() +
                                ")";
                        dtm.addRow(rdata);
                        rdata[0] = "";
                        rdata[1] = "";
                        ...
                        if (((XincoCoreData) node.getUserObject()).getXincoAddAttributes().size() >
                                0) {
                            for (i = 0; i <
                                    ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().size(); i++) {
                                rdata[0] = ((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDesignation();
                                if (((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDataType().equalsIgnoreCase("int")) {
                                    rdata[1] = "" +
                                            ((XincoAddAttribute) ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().elementAt(i)).getAttribInt();
                                }
                                if (((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDataType().equalsIgnoreCase("unsignedint")) {
                                    rdata[1] = "" +
                                            ((XincoAddAttribute) ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().elementAt(i)).getAttribUnsignedint();
                                }
                                if (((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDataType().equalsIgnoreCase("double")) {
                                    rdata[1] = "" +
                                            ((XincoAddAttribute) ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().elementAt(i)).getAttribDouble();
                                }
                                if (((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDataType().equalsIgnoreCase("varchar")) {
                                    rdata[1] = "" +
                                            ((XincoAddAttribute) ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().elementAt(i)).getAttribVarchar();
                                }
                                if (((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDataType().equalsIgnoreCase("text")) {
                                    rdata[1] = "" +
                                            ((XincoAddAttribute) ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().elementAt(i)).getAttribText();
                                }
                                if (((XincoCoreDataTypeAttribute) ((XincoCoreData) node.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getDataType().equalsIgnoreCase("datetime")) {
                                    rdata[1] = "" +
                                            ((XincoAddAttribute) ((XincoCoreData) node.getUserObject()).getXincoAddAttributes().elementAt(i)).getAttribDatetime().getTime();
                                }
                                dtm.addRow(rdata);
                            }
                        } else {
                        ...
                        for (i = ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().size() -
                                        1; i >=
                                0; i--) {
                            if (((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getOpDatetime() !=
                                    null) {
                                try {
                                    // convert clone from remote time to local time
                                    cal = (Calendar) ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getOpDatetime().clone();
                                    realcal = ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getOpDatetime();
                            ...
                            rdata[1] = "(" +
                                    ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getOpCode() +
                                    ") " +
                                    ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getOpDescription();
                            dtm.addRow(rdata);
                            rdata[0] = "";
                            try {
                                rdata[1] = xerb.getString("general.version") +
                                        " " +
                                        ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getVersion().getVersionHigh() +
                                        "." +
                                        ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getVersion().getVersionMid() +
                                        "." +
                                        ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getVersion().getVersionLow() +
                                        "" +
                                        ((XincoCoreLog) ((XincoCoreData) node.getUserObject()).getXincoCoreLogs().elementAt(i)).getVersion().getVersionPostfix();
                            } catch (Exception ex) {
                                ex.printStackTrace();
                            }
                            dtm.addRow(rdata);
                    ...
                    XincoAutofitTableColumns.autoResizeTable(jTableRepository,
                            true);
                }
            });
                    ...
                    if (selRow != -1) {
                        if (e.getClickCount() == 1) {
                            ...
                            if (xincoClientSession.getCurrentTreeNodeSelection().getUserObject().getClass() ==
                                    XincoCoreData.class) {
                                // file = 1
                                if (((XincoCoreData) xincoClientSession.getCurrentTreeNodeSelection().getUserObject()).getXincoCoreDataType().getId() ==
                                        1) {
                                    doDataWizard(14);
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (xincoClientSession.getStatus() == 1) {
                        try {
                            ...
                            if ((xincoClientVersion.getVersionHigh() != xincoClientSession.getServer_version().getVersionHigh()) || (xincoClientVersion.getVersionMid() != xincoClientSession.getServer_version().getVersionMid())) {
                                throw new XincoException(xerb.getString("menu.connection.error.serverversion") + " " + xincoClientSession.getServer_version().getVersionHigh() + "." + xincoClientSession.getServer_version().getVersionMid() + ".x");
                            }
                            ...
                            for (i = 0; i < xincoClientSession.getUser().getXincoCoreGroups().size(); i++) {
                                status_string_1 = status_string_1 + "      + " + ((XincoCoreGroup) xincoClientSession.getUser().getXincoCoreGroups().elementAt(i)).getDesignation() + "\n";
                            }
    ...
    private class loginThread extends Thread {
        ...
        public void run() {
            try {
                ...
                status_string += xerb.getString("menu.connection.connectedto") + ": " + xincoClientSession.getService_endpoint() + "\n";
                status_string += xerb.getString("general.serverversion") + ": ";
                status_string += xincoClientSession.getServer_version().getVersionHigh() + ".";
                status_string += xincoClientSession.getServer_version().getVersionMid() + ".";
                status_string += xincoClientSession.getServer_version().getVersionLow();
                status_string += xincoClientSession.getServer_version().getVersionPostfix() + "\n";
                status_string += "\n";
                ...
                status_string += xerb.getString("general.groupsonserver") + ": " + xincoClientSession.getServer_groups().size() + "\n";
                status_string += xerb.getString("general.languagesonserver") + ": " + xincoClientSession.getServer_languages().size() + "\n";
                status_string += xerb.getString("general.datatypesonserver") + ": " + xincoClientSession.getServer_datatypes().size() + "\n";
                    ...
                    if (jListDialogRevision.getSelectedIndex() >= 0) {
                        for (i = 0; i < ((XincoCoreData) xincoClientSession.getCurrentTreeNodeSelection().getUserObject()).getXincoCoreLogs().size(); i++) {
                            ...
                            if (RealLogIndex == jListDialogRevision.getSelectedIndex()) {
                                global_dialog_return_value = ((XincoCoreLog) ((XincoCoreData) xincoClientSession.getCurrentTreeNodeSelection().getUserObject()).getXincoCoreLogs().elementAt(i)).getId();
                                break;
                            }
                        }
        ...
        for (i = 0; i < folder_list.length; i++) {
            if (folder_list[i].isFile()) {
                ...
                for (j = 0; j <
                    ...
                    xaa.setAttribute_id(((XincoCoreDataTypeAttribute) xcdt1.getXincoCoreDataTypeAttributes().elementAt(j)).getAttribute_id());
                ...
                if (((xincoClientSession.getServer_version().getVersionHigh() == 1) &&
                        (xincoClientSession.getServer_version().getVersionMid() >= 9)) ||
                        (xincoClientSession.getServer_version().getVersionHigh() > 1)) {
                    useSAAJ = true;
                } else {
                    useSAAJ = false;
                }
                ...
                try {
                    ...
                    // update attributes
                    ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(0)).setAttrib_varchar(folder_list[i].getName());
                    ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(1)).setAttrib_unsignedint(total_len);
                    ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(2)).setAttrib_varchar("" +
                            cin.getChecksum().getValue());
                    ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(3)).setAttrib_unsignedint(1);
                    ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(4)).setAttrib_unsignedint(0);
                    if (!useSAAJ) {
                        cin.close();
                    }
                } catch (Exception fe) {
        ...
        if (xincoClientSession.getCurrentTreeNodeSelection() != null) {
            ...
            try {
                ...
                if ((wizard_type == 1) &&
                    ...
                    ((XincoCoreData) newnode.getUserObject()).setXincoCoreDataType((XincoCoreDataType) xincoClientSession.getServer_datatypes().elementAt(0));
                    ((XincoCoreData) newnode.getUserObject()).setXincoCoreLanguage((XincoCoreLanguage) xincoClientSession.getServer_languages().elementAt(0));
                    ((XincoCoreData) newnode.getUserObject()).setXinco_add_attributes(new Vector());
                    ((XincoCoreData) newnode.getUserObject()).setXinco_core_acl(new Vector());
                    ((XincoCoreData) newnode.getUserObject()).setXincoCoreLogs(new Vector());
                    ((XincoCoreData) newnode.getUserObject()).setStatusNumber(1);
                    ...
                    for (i = 0; i < ((XincoCoreData) newnode.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().size(); i++) {
                        xaa = new XincoAddAttribute();
                        xaa.setAttribute_id(((XincoCoreDataTypeAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoCoreDataType().getXincoCoreDataTypeAttributes().elementAt(i)).getAttribute_id());
                        xaa.setAttrib_varchar("");
                        xaa.setAttribText("");
                        xaa.setAttrib_datetime(new GregorianCalendar());
                        ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().addElement(xaa);
                    ...
                    if (((XincoCoreData) newnode.getUserObject()).getXincoCoreDataType().getId() == 1) {
                        ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(3)).setAttrib_unsignedint(1); //revision model
                        ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(4)).setAttrib_unsignedint(0); //archiving model
                    }
                ...
                if (xincoClientSession.getCurrentTreeNodeSelection().getUserObject().getClass() == XincoCoreData.class) {
                    ...
                    long total_len = 0;
                    boolean useSAAJ = false;
                    if (((xincoClientSession.getServer_version().getVersionHigh() == 1) && (xincoClientSession.getServer_version().getVersionMid() >= 9)) || (xincoClientSession.getServer_version().getVersionHigh() > 1)) {
                        useSAAJ = true;
                    } else {
                        useSAAJ = false;
                    }
                    ByteArrayOutputStream out = null;
                    //file = 1
                    if (((wizard_type == 1) || (wizard_type == 6)) && (((XincoCoreData) newnode.getUserObject()).getXincoCoreDataType().getId() == 1)) {
                        try {
                            ...
                            //update attributes
                            ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(0)).setAttrib_varchar(current_filename);
                            ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(1)).setAttrib_unsignedint(total_len);
                            ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(2)).setAttrib_varchar("" + ((CheckedInputStream) in).getChecksum().getValue());
                            if (!useSAAJ) {
                                in.close();
                            }
                        } catch (Exception fe) {
                    ...
                    if (((wizard_type == 4) || (wizard_type == 7) || (wizard_type == 11) ||
                        ...
                        if (wizard_type == 11) {
                            ...
                            for (i = 0; i < ((XincoCoreData) newnode.getUserObject()).getXincoCoreLogs().size(); i++) {
                                if (((XincoCoreLog) ((XincoCoreData) newnode.getUserObject()).getXincoCoreLogs().elementAt(i)).getId() == global_dialog_return_value) {
                        ...
                        if (wizard_type != 11) {
                            //if ((((XincoAddAttribute)((XincoCoreData)newnode.getUserObject()).getXincoAddAttributes().elementAt(1)).getAttribUnsignedint() != total_len) || (((XincoAddAttribute)((XincoCoreData)newnode.getUserObject()).getXincoAddAttributes().elementAt(2)).getAttribVarchar().equals(new String("" + couts.getChecksum().getValue())))) {
                            if (((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(1)).getAttribUnsignedint() != total_len) {
                    ...
                    //Open cin Browser
                    //URL = 3
                    if ((wizard_type == 8) && (((XincoCoreData) newnode.getUserObject()).getXincoCoreDataType().getId() == 3)) {
                        //open URL cin default browser
                        Process process = null;
                        String temp_url = ((XincoAddAttribute) ((XincoCoreData) newnode.getUserObject()).getXincoAddAttributes().elementAt(0)).getAttribVarchar();
                        if (System.getProperty("os.name").toLowerCase().indexOf("mac") > -1) {
                            try {
                    ...
                    //contact = 4
                    if ((wizard_type == 9) && (((XincoCoreData) newnode.getUserObject()).getXincoCoreDataType().getId() == 4)) {
                        //open URL cin default browser
                        Process process = null;
                    ...
                    if ((wizard_type != 7) && (wizard_type != 8) && (wizard_type != 9) && (wizard_type != 11) && (wizard_type != 14)) {
                        ...
                        if (wizard_type == 10) {
                            ...
                            if (xdata.getXincoCoreDataType().getId() == 1) {
                                temp_url = ((XincoAddAttribute) xdata.getXincoAddAttributes().elementAt(0)).getAttribVarchar();
                            } else {
    ...
    private javax.swing.JDialog getJDialogAddAttributesText() {
        ...
        //processing independent of creation
        if (((XincoCoreData) xincoClientSession.getCurrentTreeNodeSelection().getUserObject()).getStatusNumber() == 1) {
            jButtonDialogAddAttributesTextSave.setEnabled(true);
        } else {
            jButtonDialogAddAttributesTextSave.setEnabled(false);
        }
        jTextAreaDialogAddAttributesText.setText(((XincoAddAttribute) ((XincoCoreData) xincoClientSession.getCurrentTreeNodeSelection().getUserObject()).getXincoAddAttributes().elementAt(0)).getAttribText());
