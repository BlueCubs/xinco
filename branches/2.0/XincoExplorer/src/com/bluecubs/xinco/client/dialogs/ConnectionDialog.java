...
public class ConnectionDialog extends javax.swing.JDialog {
    ...
    private void connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectActionPerformed
        ...
        if (this.profileList.getSelectedIndex() >= 0) {
            ...
            ((XincoClientConnectionProfile) ((Vector)explorer.getConfig().elementAt(0)).elementAt(this.profileList.getSelectedIndex())).save_password = this.savePassword.isSelected();
        }
        //save profiles
        explorer.saveConfig();
        setVisible(false);
