...
public class DataTypeDialog extends javax.swing.JDialog {
    ...
    public DataTypeDialog(java.awt.Frame parent, boolean modal, XincoExplorer explorer) {
        ...
        if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject() != null) {
            ...
            for (i = 0; i < explorer.getSession().getServer_datatypes().size(); i++) {
                ...
                dlm.addElement(text);
                if (((XincoCoreDataType) explorer.getSession().getServer_datatypes().elementAt(i)).getId() == ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject()).getXincoCoreDataType().getId()) {
    ...
    private void continueButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continueButtonActionPerformed
        ((XincoCoreData) explorer.getSession().getCurrentTreeNodeSelection().getUserObject()).setXincoCoreDataType((XincoCoreDataType) explorer.getSession().getServer_datatypes().elementAt(this.dataType.getSelectedIndex()));
