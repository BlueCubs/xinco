...
public class XincoPopUpMenuRepository extends JPopupMenu {
    ...
    public JMenuItem AddData = null,  AddDataStructure = null,  ViewURL = null,  EmailContact = null,  EditFolderData = null,  CheckoutData = null,  UndoCheckoutData = null,  CheckinData = null,  PublishData = null,  LockData = null,  DownloadRevision = null,  Refresh = null,  AddFolder = null,  ViewEditAddAttributes = null,  EditFolderDataACL = null,  MoveFolderData = null,  InsertFolderData = null,  ViewData = null,  CommentData = null;
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                if (explorer.getSession().getCurrentTreeNodeSelection() != null) {
                    if (explorer.getSession().getCurrentTreeNodeSelection().getUserObject().getClass() == XincoCoreNode.class) {
                        ...
                        ((XincoCoreNode) newnode.getUserObject()).setXincoCoreLanguage((XincoCoreLanguage) explorer.getSession().getServer_languages().elementAt(0));
                    ...
                    for (i = 0; i < cb_size; i++) {
                        ...
                        if (explorer.getSession().getCurrentTreeNodeSelection() !=
                            ...
                            if (temp_node.getUserObject().getClass() ==
                                    XincoCoreNode.class) {
                                // modify moved node
                                old_parent_node_id = ((XincoCoreNode) temp_node.getUserObject()).getXincoCoreNodeId();
                                ((XincoCoreNode) temp_node.getUserObject()).setXincoCoreNodeId(((XincoCoreNode) explorer.getSession().getCurrentTreeNodeSelection().getUserObject()).getId());
                                try {
                                    // modify treemodel
                                    ...
                                    // undo modification
                                    ((XincoCoreNode) temp_node.getUserObject()).setXincoCoreNodeId(old_parent_node_id);
                            ...
                            if (temp_node.getUserObject().getClass() ==
                                    XincoCoreData.class) {
                                // modify moved data
                                old_parent_node_id = ((XincoCoreData) temp_node.getUserObject()).getXincoCoreNodeId();
                                ((XincoCoreData) temp_node.getUserObject()).setXincoCoreNodeId(((XincoCoreNode) explorer.getSession().getCurrentTreeNodeSelection().getUserObject()).getId());
                                try {
                                    // modify treemodel
                                    explorer.getSession().getXincoClientRepository().treemodel.removeNodeFromParent(temp_node);
                                    explorer.getSession().getXincoClientRepository().treemodel.insertNodeInto(temp_node,
                                    ...
                                    try {
                                        ...
                                        Vector oldlogs = ((XincoCoreData) temp_node.getUserObject()).getXincoCoreLogs();

                                        newlog.setXincoCoreDataId(((XincoCoreData) temp_node.getUserObject()).getId());
                                    ...
                                    // undo modification
                                    ((XincoCoreData) temp_node.getUserObject()).setXincoCoreNodeId(old_parent_node_id);
                                    JOptionPane.showMessageDialog(explorer,
