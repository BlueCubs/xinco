...
public class XincoSettingManagerView extends FrameView {
    ...
    public void deleteRecord() {
        ...
        ArrayList<XincoSetting> toRemove = new ArrayList<XincoSetting>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            XincoSetting temp = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(temp);
            ...
            return new Task(getApplication()) {
                    ...
                    protected Void doInBackground() throws RemoteException {
                            ...
                            try {
                                ...
                                getSession().setUser(getSession().getXinco().getCurrentXincoCoreUser(status_string_1, status_string_1));
                                String space = "      + ";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.bluecubs.xinco.client.XincoSettingManagerApp.class).getContext().getResourceMap(XincoSettingManagerView.class);
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${intValue}"));
        columnBinding.setColumnName("Int Value");
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${stringValue}"));
        columnBinding.setColumnName("String Value");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${boolValue}"));
        columnBinding.setColumnName("Bool Value");
        columnBinding.setColumnClass(Boolean.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${longValue}"));
        columnBinding.setColumnName("Long Value");
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.bluecubs.xinco.client.XincoSettingManagerApp.class).getContext().getActionMap(XincoSettingManagerView.class, this);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(intValueField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(stringValueField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(boolValueField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(longValueField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addContainerGap()
    ...
    private java.util.List<com.bluecubs.xinco.client.XincoSetting> list;
