    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                try {
                    ...
                    if (rs.next()) {
                        ...
                        long attempts = DBM.getSetting("password.attempts").getIntValue();
        ...
        if (request.getParameter("DialogNewUserSubmit") != null) {
            try {
                ...
                temp_user.getXincoCoreGroups().addElement(temp_group);
                //The logged in admin does the locking
                if (login_user == null) {
        ...
        if (request.getParameter("changePassword") != null) {
            ...
            if (!request.getParameter("new").equals(request.getParameter("confirm"))) {
                ...
                out.println("<br><span class=\"bigtext\">"+
                        java.util.ResourceBundle.getBundle("com/bluecubs/xinco/web/web_messages").getString("window.title.XincoAdmin")+"</span><br><br>");
        ...
        out.println("<head>");
        out.println("<title>"+
                        java.util.ResourceBundle.getBundle("com/bluecubs/xinco/web/web_messages").getString("window.title.XincoAdmin")+"</title>");
        ...
        if (status == 0) {
            ...
            out.println("<br><span class=\"bigtext\">XincoAdmin</span><br><br>");out.println("<br><span class=\"bigtext\">"+
                        java.util.ResourceBundle.getBundle("com/bluecubs/xinco/web/web_messages").getString("window.title.XincoAdmin")+"</span><br><br>");if (error_message.compareTo("") != 0) {
            ...
            if (current_location.compareTo("UserAdmin") == 0) {
                ...
                for (i = 0; i < allusers.size(); i++) {
                    ...
                    if (((XincoCoreUserServer) allusers.elementAt(i)).getStatusNumber() == 1) {
                    ...
                    if (((XincoCoreUserServer) allusers.elementAt(i)).getStatusNumber() == 2) {
            ...
            if (current_location.compareTo("GroupAdminSingle") == 0) {
                ...
                for (i = 0; i < allusers.size(); i++) {
                    ...
                    for (j = 0; j < ((XincoCoreUserServer) allusers.elementAt(i)).getXincoCoreGroups().size(); j++) {
                        if (((XincoCoreGroupServer) ((XincoCoreUserServer) allusers.elementAt(i)).getXincoCoreGroups().elementAt(j)).getId() == current_group_selection) {
            ...
            if (current_location.compareTo("AttributesAdminSingle") == 0) {
                ...
                try {
                    ...
                    out.println("<td class=\"bigtext\">&nbsp;</td>");
                    out.println("</tr>");
                    for (i = 0; i < temp_datatype.getXincoCoreDataTypeAttributes().size(); i++) {
                        out.println("<tr>");
                        out.println("<td class=\"text\">" + ((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getAttribute_id() + "</td>");
                        out.println("<td class=\"text\">" + ((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getDesignation() + "</td>");
                        out.println("<td class=\"text\">" + ((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getDataType() + "</td>");
                        out.println("<td class=\"text\">" + ((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getSize() + "</td>");
                        if (((current_datatype_selection == 1) && (((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getAttribute_id() <= 8)) || ((current_datatype_selection == 2) && (((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getAttribute_id() <= 1)) || ((current_datatype_selection == 3) && (((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getAttribute_id() <= 1))) {
                            out.println("<td class=\"text\">&nbsp;</td>");
                        } else {
                            out.println("<td class=\"text\"><a href=\"XincoAdmin?DialogEditAttributesRemoveAttributeId=" +
                                    ((XincoCoreDataTypeAttributeServer) temp_datatype.getXincoCoreDataTypeAttributes().elementAt(i)).getAttribute_id() +
        ...
        out.println("<tr>");
        out.println("<td class=\"text\">&nbsp;</td>");
        out.println("<td class=\"text\">&copy; " + DBM.getSetting("general.copyright.date").getStringValue() + ", " +
                //Avoid external links if general.setting.allowoutsidelinks is set to false
                //Security bug
