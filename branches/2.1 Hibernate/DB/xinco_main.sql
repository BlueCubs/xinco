...
-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_language`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_language` (
...
CREATE UNIQUE INDEX `xinco_core_language_unique` ON `mydb`.`xinco_core_language` (`designation` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_node`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_node` (
  `id` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_core_node_FKIndex1` ON `mydb`.`xinco_core_node` (`xinco_core_node_id` ASC) ;

CREATE INDEX `xinco_core_node_FKIndex2` ON `mydb`.`xinco_core_node` (`xinco_core_language_id` ASC) ;

CREATE INDEX `xinco_core_node_index_designation` ON `mydb`.`xinco_core_node` (`designation` ASC) ;

CREATE INDEX `xinco_core_node_index_status` ON `mydb`.`xinco_core_node` (`status_number` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_data_type`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_data_type` (
  `id` INT UNSIGNED NOT NULL ,
  `designation` VARCHAR(255) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_data`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_data` (
  `id` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_core_data_FKIndex1` ON `mydb`.`xinco_core_data` (`xinco_core_node_id` ASC) ;

CREATE INDEX `xinco_core_data_FKIndex2` ON `mydb`.`xinco_core_data` (`xinco_core_language_id` ASC) ;

CREATE INDEX `xinco_core_data_FKIndex3` ON `mydb`.`xinco_core_data` (`xinco_core_data_type_id` ASC) ;

CREATE INDEX `xinco_core_data_index_designation` ON `mydb`.`xinco_core_data` (`designation` ASC) ;

CREATE INDEX `xinco_core_data_index_status` ON `mydb`.`xinco_core_data` (`status_number` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_user`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_user` (
  `id` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_core_user_index_username` ON `mydb`.`xinco_core_user` (`username` ASC) ;

CREATE INDEX `xinco_core_user_index_status` ON `mydb`.`xinco_core_user` (`status_number` ASC) ;

CREATE UNIQUE INDEX `xinco_core_user_index_unique` ON `mydb`.`xinco_core_user` (`username` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_group` (
  `id` INT UNSIGNED NOT NULL ,
  `designation` VARCHAR(255) NOT NULL ,
  `status_number` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`id`) )
...
CREATE INDEX `xinco_core_group_index_status` ON `mydb`.`xinco_core_group` (`status_number` ASC) ;

CREATE UNIQUE INDEX `xinco_core_group_unique` ON `mydb`.`xinco_core_group` (`designation` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_ace`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_ace` (
  `id` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_core_ace_FKIndex1` ON `mydb`.`xinco_core_ace` (`xinco_core_user_id` ASC) ;

CREATE INDEX `xinco_core_ace_FKIndex2` ON `mydb`.`xinco_core_ace` (`xinco_core_group_id` ASC) ;

CREATE INDEX `xinco_core_ace_FKIndex3` ON `mydb`.`xinco_core_ace` (`xinco_core_node_id` ASC) ;

CREATE INDEX `xinco_core_ace_FKIndex4` ON `mydb`.`xinco_core_ace` (`xinco_core_data_id` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_user_has_xinco_core_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_user_has_xinco_core_group` (
  `xinco_core_user_id` INT UNSIGNED NOT NULL ,
  `xinco_core_group_id` INT UNSIGNED NOT NULL ,
  `status_number` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_core_user_has_xinco_core_group_FKIndex1` ON `mydb`.`xinco_core_user_has_xinco_core_group` (`xinco_core_user_id` ASC) ;

CREATE INDEX `xinco_core_user_has_xinco_core_group_FKIndex2` ON `mydb`.`xinco_core_user_has_xinco_core_group` (`xinco_core_group_id` ASC) ;

CREATE INDEX `xinco_core_user_has_xinco_core_group_index_status` ON `mydb`.`xinco_core_user_has_xinco_core_group` (`status_number` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_id`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_id` (
...
CREATE UNIQUE INDEX `Unique` ON `mydb`.`xinco_id` (`tablename` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_add_attribute`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_add_attribute` (
  `xinco_core_data_id` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_add_attribute_FKIndex1` ON `mydb`.`xinco_add_attribute` (`xinco_core_data_id` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_data_type_attribute`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_data_type_attribute` (
  `xinco_core_data_type_id` INT UNSIGNED NOT NULL ,
  `attribute_id` INT UNSIGNED NOT NULL ,
  `designation` VARCHAR(255) NOT NULL ,
...
CREATE INDEX `xinco_core_data_type_attribute_FKIndex1` ON `mydb`.`xinco_core_data_type_attribute` (`xinco_core_data_type_id` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_core_log`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_core_log` (
  `id` INT UNSIGNED NOT NULL ,
  `xinco_core_data_id` INT UNSIGNED NOT NULL ,
  `xinco_core_user_id` INT UNSIGNED NOT NULL ,
...
CREATE INDEX `xinco_core_log_FKIndex1` ON `mydb`.`xinco_core_log` (`xinco_core_data_id` ASC) ;

CREATE INDEX `xinco_core_log_FKIndex2` ON `mydb`.`xinco_core_log` (`xinco_core_user_id` ASC) ;


-- -----------------------------------------------------
-- Table `mydb`.`xinco_setting`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`xinco_setting` (
