...
<%@page import="com.bluecubs.xinco.persistence.XincoSetting"%>
...
<center>
    ...
    <%
            ...
            out.print(rb.getString("password.change.warning").replaceAll("%n", XincoSettingServer.getSetting("password.aging").getStringValue()));%>
    </span><br/><br/>
