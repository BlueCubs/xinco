...
public class XincoAddAttributeServer extends XincoAddAttribute implements XincoAuditableDAO, PersistenceServerObject {
    ...
    @Override
    public com.bluecubs.xinco.add.XincoAddAttribute transform() throws Exception {
        GregorianCalendar c = new GregorianCalendar();
        c.setTime(getAttribDatetime());
        return new com.bluecubs.xinco.add.XincoAddAttribute((Calendar) c,
                getAttribDouble(), getAttribInt(), getAttribText(), getAttribUnsignedint(),
                getAttribVarchar(), getXincoAddAttributePK().getAttributeId(),
                getXincoAddAttributePK().getXincoCoreDataId(),
                getChangerID(), false);
    }
}
