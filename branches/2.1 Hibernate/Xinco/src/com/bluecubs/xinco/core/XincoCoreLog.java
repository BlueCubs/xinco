...
public class XincoCoreLog  implements java.io.Serializable {
    ...
    private java.util.Calendar opDatetime;
     ...
     * @return opDatetime
     */
    public java.util.Calendar getOpDatetime() {
        return opDatetime;
    }
     ...
     * @param opDatetime
     */
    public void setOpDatetime(java.util.Calendar opDatetime) {
        this.opDatetime = opDatetime;
    }
