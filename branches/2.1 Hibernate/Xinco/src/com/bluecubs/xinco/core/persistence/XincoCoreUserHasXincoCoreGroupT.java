 ...
 */
@Entity
@Table(name = "xinco_core_user_has_xinco_core_group_t", catalog = "xinco", schema = "")
...
public class XincoCoreUserHasXincoCoreGroupT implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.core.persistence.XincoCoreUserHasXincoCoreGroupT[recordId=" + recordId + "]";
    }
