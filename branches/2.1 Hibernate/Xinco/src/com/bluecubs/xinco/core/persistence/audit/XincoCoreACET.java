...
public class XincoCoreACET implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.core.persistence.audit.XincoCoreACET[recordId=" + recordId + "]";
    }
