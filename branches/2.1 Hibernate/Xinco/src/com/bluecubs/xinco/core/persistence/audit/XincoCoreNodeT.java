...
public class XincoCoreNodeT implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.core.persistence.audit.XincoCoreNodeT[recordId=" + recordId + "]";
    }
