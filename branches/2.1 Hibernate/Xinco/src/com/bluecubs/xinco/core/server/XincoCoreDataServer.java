...
public class XincoCoreDataServer extends XincoCoreData implements XincoAuditableDAO, PersistenceServerObject {
    ...
    @Override
    public com.bluecubs.xinco.core.XincoCoreData transform() throws Exception {
        com.bluecubs.xinco.core.XincoCoreData temp = new com.bluecubs.xinco.core.XincoCoreData(getDesignation(),
                getXincoCoreACL(), getChangerID(),
                new XincoCoreDataTypeServer(getXincoCoreDataTypeId()).transform(),
                new XincoCoreLanguageServer(getXincoCoreLanguageId()).transform(),
                getXincoCoreNodeId(), (int) getId(),
                getStatusNumber(), getXincoAddAttributes(), getXincoCoreLogs());
        return temp;
    }
}
