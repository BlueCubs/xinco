...
public class XincoCoreDataTypeAttributeServer extends XincoCoreDataTypeAttribute implements XincoAuditableDAO,
    ...
    public com.bluecubs.xinco.core.XincoCoreDataTypeAttribute transform() throws Exception {
        return new com.bluecubs.xinco.core.XincoCoreDataTypeAttribute(getDesignation(),
                getChangerID(), getXincoCoreDataTypeAttributePK().getAttributeId(),
                getDataType(), getSize(),
                getXincoCoreDataTypeAttributePK().getXincoCoreDataTypeId());
    }
}
