...
public class XincoCoreGroupServer extends XincoCoreGroup implements XincoAuditableDAO, PersistenceServerObject {
    ...
    public com.bluecubs.xinco.core.XincoCoreGroup transform() throws Exception {
        return new com.bluecubs.xinco.core.XincoCoreGroup(getDesignation(), getChangerID(),
                getId(), getStatusNumber());
    }
}
