...
public class XincoCoreLanguageServer extends XincoCoreLanguage implements XincoAuditableDAO, PersistenceServerObject {
    ...
    @Override
    public com.bluecubs.xinco.core.XincoCoreLanguage transform() throws Exception {
        return new com.bluecubs.xinco.core.XincoCoreLanguage(getDesignation(),
                getChangerID(), getId(), getSign());
    }
}
