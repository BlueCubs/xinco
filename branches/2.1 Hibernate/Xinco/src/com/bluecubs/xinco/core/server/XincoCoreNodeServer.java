...
public class XincoCoreNodeServer extends XincoCoreNode implements XincoAuditableDAO, PersistenceServerObject {
    ...
    public com.bluecubs.xinco.core.XincoCoreNode transform() throws Exception {
        return new com.bluecubs.xinco.core.XincoCoreNode(getDesignation(),
                getChangerID(), getXincoCoreACL(), getXincoCoreData(),
                new XincoCoreLanguageServer(getXincoCoreLanguageId()).transform(),
                getId(), getXincoCoreNodes(), getId(), getStatusNumber());
    }
}
