...
//create complete list of users
    ...
    public com.bluecubs.xinco.core.XincoCoreUser transform() throws Exception {
        return new com.bluecubs.xinco.core.XincoCoreUser(isChange(), getChangerID(),
                getEmail(), getFirstname(), getId(), getName(), getReason(),
                getStatusNumber(), getUsername(), getUserpassword(),
                isWriteGroups(), getXincoCoreGroups());
    }
}
