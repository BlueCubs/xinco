...
public class XincoSoapBindingSkeleton implements com.bluecubs.xinco.service.Xinco, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    static {
        ...
        _oper = new org.apache.axis.description.OperationDesc("localizeString", _params, new javax.xml.namespace.QName("", "localizeStringReturn"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"));
        _oper.setElementQName(new javax.xml.namespace.QName("urn:Xinco", "localizeString"));
        _oper.setSoapAction("");
        _myOperationsList.add(_oper);
    ...
    {
        java.lang.String ret = impl.localizeString(in0, in1);
        return ret;
    }
