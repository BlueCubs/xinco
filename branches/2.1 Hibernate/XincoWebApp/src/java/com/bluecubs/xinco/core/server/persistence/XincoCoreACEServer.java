...
import com.bluecubs.xinco.persistence.audit.XincoCoreACET;
...
public class XincoCoreACEServer extends XincoCoreACE implements AuditableDAO, PersistenceServerObject {
    ...
    public static Vector getXincoCoreACL(int attrID, String attrT) {
        ...
        try {
            ...
            try {
                if (XincoSettingServer.getSetting("setting.enable.developermode").getBoolValue()) {
                    Logger.getLogger(XincoCoreACEServer.class.getName()).log(Level.INFO, "Error getting ACL's. (" + attrT + "=" + attrID + ")", e);
                }
    ...
    public AbstractAuditableObject getInstance(AbstractAuditableObject value) {
        try {
            XincoCoreACE temp;
    ...
    public AbstractAuditableObject create(AbstractAuditableObject value) {
        XincoCoreACE newValue = (XincoCoreACE) getInstance((AbstractAuditableObject) value);
