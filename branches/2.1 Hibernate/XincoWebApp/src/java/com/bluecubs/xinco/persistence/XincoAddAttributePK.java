...
/**
 * Class: XincoAddAttributePK
 * Created: Mar 24, 2008 2:28:52 PM
...
public class XincoAddAttributePK implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.persistence.XincoAddAttributePK[xincoCoreDataId=" + xincoCoreDataId + ", attributeId=" + attributeId + "]";
    }
