...
/**
 * Class: XincoCoreUserHasXincoCoreGroup
 * Created: Mar 24, 2008 2:25:52 PM
...
public class XincoCoreUserHasXincoCoreGroup extends XincoAbstractAuditableObject implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.persistence.XincoCoreUserHasXincoCoreGroup[xincoCoreUserHasXincoCoreGroupPK=" + xincoCoreUserHasXincoCoreGroupPK + "]";
    }
