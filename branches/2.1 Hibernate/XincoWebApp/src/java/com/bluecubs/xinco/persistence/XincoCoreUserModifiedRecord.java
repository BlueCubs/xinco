...
/**
 * Class: XincoCoreUserModifiedRecord
 * Created: Mar 24, 2008 2:27:15 PM
 * @author Javier A. Ortiz <javier.ortiz.78@gmail.com>
 */
@Entity
@Table(name = "xinco_core_user_modified_record")
@NamedQueries({@NamedQuery(name = "XincoCoreUserModifiedRecord.findById", query = "SELECT x FROM XincoCoreUserModifiedRecord x WHERE x.xincoCoreUserModifiedRecordPK.id = :id"), @NamedQuery(name = "XincoCoreUserModifiedRecord.findByRecordId", query = "SELECT x FROM XincoCoreUserModifiedRecord x WHERE x.xincoCoreUserModifiedRecordPK.recordId = :recordId"), @NamedQuery(name = "XincoCoreUserModifiedRecord.findByModReason", query = "SELECT x FROM XincoCoreUserModifiedRecord x WHERE x.modReason = :modReason"), @NamedQuery(name = "XincoCoreUserModifiedRecord.findByModTime", query = "SELECT x FROM XincoCoreUserModifiedRecord x WHERE x.modTime = :modTime")})
public class XincoCoreUserModifiedRecord implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.persistence.XincoCoreUserModifiedRecord[xincoCoreUserModifiedRecordPK=" + xincoCoreUserModifiedRecordPK + "]";
    }
