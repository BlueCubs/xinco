...
/**
 * Class: XincoCoreUserModifiedRecordPK
 * Created: Mar 24, 2008 2:27:39 PM
...
public class XincoCoreUserModifiedRecordPK implements Serializable {
    ...
    public String toString() {
        return "com.bluecubs.xinco.persistence.XincoCoreUserModifiedRecordPK[id=" + id + ", recordId=" + recordId + "]";
    }
