...
INSERT INTO xinco_core_user VALUES (1, 'admin', MD5('admin'), 'Administrator', 'Xinco', 'admin@xinco.org', 1); 
INSERT INTO xinco_core_user VALUES (2, 'user', MD5('user'), 'User', 'Default', 'user@xinco.org', 1);
...
CREATE TABLE xinco_core_node (
  id INTEGER NOT NULL,
  xinco_core_node_id INTEGER NULL,
...
CREATE INDEX xinco_core_node_FKIndex1 ON xinco_core_node (xinco_core_node_id);
CREATE INDEX xinco_core_node_FKIndex2 ON xinco_core_node (xinco_core_language_id);
CREATE INDEX xinco_core_node_index_designation ON xinco_core_node (designation);
CREATE INDEX xinco_core_node_index_status ON xinco_core_node (status_number);
...
CREATE INDEX xinco_core_data_type_attribute_FKIndex1 ON xinco_core_data_type_attribute (xinco_core_data_type_id);
...
CREATE INDEX xinco_core_user_has_xinco_core_group_FKIndex1 ON xinco_core_user_has_xinco_core_group (xinco_core_user_id);
CREATE INDEX xinco_core_user_has_xinco_core_group_FKIndex2 ON xinco_core_user_has_xinco_core_group (xinco_core_group_id);
CREATE INDEX xinco_core_user_has_xinco_core_group_index_status ON xinco_core_user_has_xinco_core_group (status_number);
...
CREATE INDEX xinco_core_data_FKIndex1 ON xinco_core_data (xinco_core_node_id);
CREATE INDEX xinco_core_data_FKIndex2 ON xinco_core_data (xinco_core_language_id);
CREATE INDEX xinco_core_data_FKIndex5 ON xinco_core_data (xinco_core_data_type_id);
CREATE INDEX xinco_core_data_index_designation ON xinco_core_data (designation);
CREATE INDEX xinco_core_data_index_status ON xinco_core_data (status_number);
...
CREATE TABLE xinco_core_ace (
  id INTEGER NOT NULL,
  xinco_core_user_id INTEGER NULL,
  xinco_core_group_id INTEGER NULL,
  xinco_core_node_id INTEGER NULL,
  xinco_core_data_id INTEGER NULL,
...
CREATE INDEX xinco_core_ace_FKIndex1 ON xinco_core_ace (xinco_core_user_id);
CREATE INDEX xinco_core_ace_FKIndex2 ON xinco_core_ace (xinco_core_group_id);
CREATE INDEX xinco_core_ace_FKIndex3 ON xinco_core_ace (xinco_core_node_id);
CREATE INDEX xinco_core_ace_FKIndex4 ON xinco_core_ace (xinco_core_data_id);
...
CREATE TABLE xinco_add_attribute (
  ...
  attrib_unsignedint INTEGER NULL,
  attrib_double FLOAT NULL,
  attrib_varchar VARCHAR(255) NULL,
  attrib_text TEXT NULL,
  attrib_datetime TIMESTAMP NULL,
...
CREATE INDEX xinco_add_attribute_FKIndex1 ON xinco_add_attribute (xinco_core_data_id);
...
CREATE TABLE xinco_core_log (
  ...
  op_datetime TIMESTAMP NOT NULL,
  op_description VARCHAR(255) NOT NULL,
  version_high INTEGER NULL,
  version_mid INTEGER NULL,
  version_low INTEGER NULL,
...
CREATE INDEX xinco_core_log_FKIndex1 ON xinco_core_log (xinco_core_data_id);
CREATE INDEX xinco_core_log_FKIndex2 ON xinco_core_log (xinco_core_user_id);
