...
public class XincoCronServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<td class=\"text\">1</td>");
        ...
        out.println("<td class=\"text\">&copy; " + lrb.getString("general.copyright.date") + ", "
                ...
                //Security bug
                (Lookup.getDefault().lookup(ConfigurationManager.class).isAllowOutsideLinks() ? lrb.getString("message.admin.main.footer") : "blueCubs.com and xinco.org"));
        out.println("</tr>");
