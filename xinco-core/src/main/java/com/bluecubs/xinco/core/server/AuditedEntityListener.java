        ...
        synchronized (this) {
            if (o instanceof AuditedObject) {
                ...
                if (auditedObject.isAuditable()) {
                    getLogger(AuditedEntityListener.class.getName()).log(FINEST, "Creating audit trail for {0}", o);
                    modifier = new XincoCoreUserJpaController(getEntityManagerFactory()).findXincoCoreUser(auditedObject.getModifierId());
                    if (modifier == null) {
                        //Default to admin
                        modifier = new XincoCoreUserJpaController(getEntityManagerFactory()).findXincoCoreUser(1);
                    }
                    ...
                    getLogger(AuditedEntityListener.class.getName()).log(FINEST, "Created XincoCoreUserModifiedRecord record");
                    boolean updated = false;
                    if (o instanceof XincoCoreNode) {
                        XincoCoreNode node = (XincoCoreNode) o;
                        new XincoCoreNodeTJpaController(getEntityManagerFactory()).create(new XincoCoreNodeT(record_ID, node.getId(),
                    ...
                    if (o instanceof XincoCoreLanguage) {
                        ...
                        new XincoCoreLanguageTJpaController(getEntityManagerFactory()).create(new XincoCoreLanguageT(record_ID, lang.getId(),
                                lang.getSign(), lang.getDesignation()));
                        updated = true;
                    }
                    if (o instanceof XincoCoreGroup) {
                        XincoCoreGroup group = (XincoCoreGroup) o;
                        new XincoCoreGroupTJpaController(getEntityManagerFactory()).create(new XincoCoreGroupT(record_ID, group.getId(),
                                group.getDesignation(), group.getStatusNumber()));
                        updated = true;
                    }
                    if (o instanceof XincoCoreDataType) {
                        XincoCoreDataType type = (XincoCoreDataType) o;
                        new XincoCoreDataTypeTJpaController(getEntityManagerFactory()).create(new XincoCoreDataTypeT(record_ID, type.getId(),
                    ...
                    if (o instanceof XincoCoreDataTypeAttribute) {
                        ...
                        new XincoCoreDataTypeAttributeTJpaController(getEntityManagerFactory()).create(new XincoCoreDataTypeAttributeT(record_ID,
                    ...
                    if (o instanceof XincoCoreData) {
                        ...
                        new XincoCoreDataTJpaController(getEntityManagerFactory()).create(new XincoCoreDataT(record_ID,
                                data.getId(),
                    ...
                    if (o instanceof XincoCoreAce) {
                        ...
                        new XincoCoreAceTJpaController(getEntityManagerFactory()).create(new XincoCoreAceT(record_ID,
                                ace.getId(),
                    ...
                    if (o instanceof XincoAddAttribute) {
                        ...
                        new XincoAddAttributeTJpaController(getEntityManagerFactory()).create(new XincoAddAttributeT(record_ID,
                    ...
                    if (o instanceof XincoSetting) {
                        ...
                        new XincoSettingTJpaController(getEntityManagerFactory()).create(new XincoSettingT(record_ID,
                                setting.getId(),
