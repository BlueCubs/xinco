...
/**
 * See http://wiki.eclipse.org/Customizing_the_EclipseLink_Application_(ELUG) Use for clients that
 * would like to use a JTA SE pu instead of a RESOURCE_LOCAL SE pu.
 */
