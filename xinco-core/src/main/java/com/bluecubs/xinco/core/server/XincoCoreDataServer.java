...
public final class XincoCoreDataServer extends XincoCoreData
{
  ...
  /**
   * This will get the latest major revision. Basically the last version with a
   * '0' as a mid version
   *
  ...
  public int write2DB() throws XincoException
  {
    ...
    try
    {
              ...
              : getXincoAddAttributes())
      {
         ...
         * (Persistence). The delete and create approach doesn't go well with
         * persistence.
         */
