...
public final class XincoIdServer extends XincoId {
  ...
  public XincoIdServer(Integer id) throws XincoException {
    XincoIdJpaController controller = new XincoIdJpaController(getEntityManagerFactory());
  ...
  public static XincoIdServer getXincoId(String table) throws XincoException {
    ...
    if (!result.isEmpty()) {
      return new XincoIdServer(
          ((com.bluecubs.xinco.core.server.persistence.XincoId) result.get(0)).getId());
    } else {
