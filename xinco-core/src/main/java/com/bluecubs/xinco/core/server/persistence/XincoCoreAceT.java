...
@NamedQueries({
  ...
  @NamedQuery(
      name = "XincoCoreAceT.findByRecordId",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.recordId = :recordId"),
  @NamedQuery(
      name = "XincoCoreAceT.findById",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.id = :id"),
  @NamedQuery(
      name = "XincoCoreAceT.findByXincoCoreUserId",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.xincoCoreUserId = :xincoCoreUserId"),
  @NamedQuery(
      name = "XincoCoreAceT.findByXincoCoreGroupId",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.xincoCoreGroupId = :xincoCoreGroupId"),
  @NamedQuery(
      name = "XincoCoreAceT.findByXincoCoreNodeId",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.xincoCoreNodeId = :xincoCoreNodeId"),
  @NamedQuery(
      name = "XincoCoreAceT.findByXincoCoreDataId",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.xincoCoreDataId = :xincoCoreDataId"),
  @NamedQuery(
      name = "XincoCoreAceT.findByReadPermission",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.readPermission = :readPermission"),
  @NamedQuery(
      name = "XincoCoreAceT.findByWritePermission",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.writePermission = :writePermission"),
  @NamedQuery(
      name = "XincoCoreAceT.findByExecutePermission",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.executePermission = :executePermission"),
  @NamedQuery(
      name = "XincoCoreAceT.findByAdminPermission",
      query = "SELECT x FROM XincoCoreAceT x WHERE x.adminPermission = :adminPermission")
})
