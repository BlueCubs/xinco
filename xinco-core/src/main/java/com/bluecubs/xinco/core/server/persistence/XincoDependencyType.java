...
@NamedQueries({
  ...
  @NamedQuery(
      name = "XincoDependencyType.findById",
      query = "SELECT x FROM XincoDependencyType x WHERE x.id = :id"),
  @NamedQuery(
      name = "XincoDependencyType.findByDesignation",
      query = "SELECT x FROM XincoDependencyType x WHERE x.designation = :designation"),
  @NamedQuery(
      name = "XincoDependencyType.findByDescription",
      query = "SELECT x FROM XincoDependencyType x WHERE x.description = :description")
})
