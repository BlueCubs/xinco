...
public class XincoAddAttributeJpaController implements Serializable {
  ...
  public void create(XincoAddAttribute xincoAddAttribute)
      throws PreexistingEntityException, Exception {
    if (xincoAddAttribute.getXincoAddAttributePK() == null) {
      xincoAddAttribute.setXincoAddAttributePK(new XincoAddAttributePK());
    }
    xincoAddAttribute
        .getXincoAddAttributePK()
        .setXincoCoreDataId(xincoAddAttribute.getXincoCoreData().getId());
    ...
    try {
      ...
      if (findXincoAddAttribute(xincoAddAttribute.getXincoAddAttributePK()) != null) {
        throw new PreexistingEntityException(
            "XincoAddAttribute " + xincoAddAttribute + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoAddAttribute xincoAddAttribute)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoAddAttribute persistentXincoAddAttribute =
          em.find(XincoAddAttribute.class, xincoAddAttribute.getXincoAddAttributePK());
  ...
  private List<XincoAddAttribute> findXincoAddAttributeEntities(
