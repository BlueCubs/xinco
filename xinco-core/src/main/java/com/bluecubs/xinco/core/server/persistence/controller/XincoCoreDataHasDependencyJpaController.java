...
public class XincoCoreDataHasDependencyJpaController implements Serializable {
  ...
  public void create(XincoCoreDataHasDependency xincoCoreDataHasDependency)
      throws PreexistingEntityException, Exception {
    if (xincoCoreDataHasDependency.getXincoCoreDataHasDependencyPK() == null) {
      xincoCoreDataHasDependency.setXincoCoreDataHasDependencyPK(
          new XincoCoreDataHasDependencyPK());
    }
    xincoCoreDataHasDependency
        .getXincoCoreDataHasDependencyPK()
        .setXincoCoreDataChildrenId(xincoCoreDataHasDependency.getXincoCoreData().getId());
    xincoCoreDataHasDependency
        .getXincoCoreDataHasDependencyPK()
        .setXincoCoreDataParentId(xincoCoreDataHasDependency.getXincoCoreData1().getId());
    xincoCoreDataHasDependency
        .getXincoCoreDataHasDependencyPK()
        .setDependencyTypeId(xincoCoreDataHasDependency.getXincoDependencyType().getId());
    ...
    try {
      ...
      if (findXincoCoreDataHasDependency(
              xincoCoreDataHasDependency.getXincoCoreDataHasDependencyPK())
          != null) {
        throw new PreexistingEntityException(
            "XincoCoreDataHasDependency " + xincoCoreDataHasDependency + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreDataHasDependency xincoCoreDataHasDependency)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreDataHasDependency persistentXincoCoreDataHasDependency =
          em.find(
              XincoCoreDataHasDependency.class,
              xincoCoreDataHasDependency.getXincoCoreDataHasDependencyPK());
      XincoDependencyType xincoDependencyTypeOld =
          persistentXincoCoreDataHasDependency.getXincoDependencyType();
      XincoDependencyType xincoDependencyTypeNew =
          xincoCoreDataHasDependency.getXincoDependencyType();
      ...
      if (xincoDependencyTypeOld != null
          && !xincoDependencyTypeOld.equals(xincoDependencyTypeNew)) {
        xincoDependencyTypeOld
            .getXincoCoreDataHasDependencyList()
            .remove(xincoCoreDataHasDependency);
        xincoDependencyTypeOld = em.merge(xincoDependencyTypeOld);
      }
      if (xincoDependencyTypeNew != null
          && !xincoDependencyTypeNew.equals(xincoDependencyTypeOld)) {
  ...
  private List<XincoCoreDataHasDependency> findXincoCoreDataHasDependencyEntities(
  ...
  public XincoCoreDataHasDependency findXincoCoreDataHasDependency(
      XincoCoreDataHasDependencyPK id) {
    EntityManager em = getEntityManager();
    try {
