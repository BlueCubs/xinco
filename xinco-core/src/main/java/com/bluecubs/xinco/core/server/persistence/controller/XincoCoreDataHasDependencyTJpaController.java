...
public class XincoCoreDataHasDependencyTJpaController implements Serializable {
  ...
  public void create(XincoCoreDataHasDependencyT xincoCoreDataHasDependencyT)
    ...
    try {
      ...
      if (findXincoCoreDataHasDependencyT(xincoCoreDataHasDependencyT.getRecordId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreDataHasDependencyT " + xincoCoreDataHasDependencyT + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreDataHasDependencyT xincoCoreDataHasDependencyT)
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoCoreDataHasDependencyT(id) == null) {
          throw new NonexistentEntityException(
              "The xincoCoreDataHasDependencyT with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws NonexistentEntityException {
    ...
    try {
      ...
      XincoCoreDataHasDependencyT xincoCoreDataHasDependencyT =
          em.find(XincoCoreDataHasDependencyT.class, id);

      if (xincoCoreDataHasDependencyT == null) {
        throw new NonexistentEntityException(
            "The xincoCoreDataHasDependencyT with id " + id + " no longer exists.");
      }
  ...
  private List<XincoCoreDataHasDependencyT> findXincoCoreDataHasDependencyTEntities(
