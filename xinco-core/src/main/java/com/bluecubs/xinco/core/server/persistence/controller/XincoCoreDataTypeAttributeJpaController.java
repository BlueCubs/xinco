...
public class XincoCoreDataTypeAttributeJpaController implements Serializable {
  ...
  public void create(XincoCoreDataTypeAttribute xincoCoreDataTypeAttribute)
      throws PreexistingEntityException, Exception {
    if (xincoCoreDataTypeAttribute.getXincoCoreDataTypeAttributePK() == null) {
      xincoCoreDataTypeAttribute.setXincoCoreDataTypeAttributePK(
          new XincoCoreDataTypeAttributePK());
    }
    xincoCoreDataTypeAttribute
        .getXincoCoreDataTypeAttributePK()
        .setXincoCoreDataTypeId(xincoCoreDataTypeAttribute.getXincoCoreDataType().getId());
    ...
    try {
      ...
      if (findXincoCoreDataTypeAttribute(
              xincoCoreDataTypeAttribute.getXincoCoreDataTypeAttributePK())
          != null) {
        throw new PreexistingEntityException(
            "XincoCoreDataTypeAttribute " + xincoCoreDataTypeAttribute + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreDataTypeAttribute xincoCoreDataTypeAttribute)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreDataTypeAttribute persistentXincoCoreDataTypeAttribute =
          em.find(
              XincoCoreDataTypeAttribute.class,
              xincoCoreDataTypeAttribute.getXincoCoreDataTypeAttributePK());
      XincoCoreDataType xincoCoreDataTypeOld =
          persistentXincoCoreDataTypeAttribute.getXincoCoreDataType();
  ...
  private List<XincoCoreDataTypeAttribute> findXincoCoreDataTypeAttributeEntities(
  ...
  public XincoCoreDataTypeAttribute findXincoCoreDataTypeAttribute(
      XincoCoreDataTypeAttributePK id) {
    EntityManager em = getEntityManager();
    try {
