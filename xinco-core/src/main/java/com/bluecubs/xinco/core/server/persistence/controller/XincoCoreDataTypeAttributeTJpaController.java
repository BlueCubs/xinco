...
public class XincoCoreDataTypeAttributeTJpaController implements Serializable {
  ...
  public void create(XincoCoreDataTypeAttributeT xincoCoreDataTypeAttributeT)
    ...
    try {
      ...
      if (findXincoCoreDataTypeAttributeT(xincoCoreDataTypeAttributeT.getRecordId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreDataTypeAttributeT " + xincoCoreDataTypeAttributeT + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreDataTypeAttributeT xincoCoreDataTypeAttributeT)
  ...
  private List<XincoCoreDataTypeAttributeT> findXincoCoreDataTypeAttributeTEntities(
