...
public class XincoCoreDataTypeJpaController implements Serializable {
  ...
  public void create(XincoCoreDataType xincoCoreDataType)
    ...
    if (xincoCoreDataType.getXincoCoreDataTypeAttributeList() == null) {
      xincoCoreDataType.setXincoCoreDataTypeAttributeList(new ArrayList<>());
    }
    if (xincoCoreDataType.getXincoCoreDataList() == null) {
      xincoCoreDataType.setXincoCoreDataList(new ArrayList<>());
    }
    ...
    try {
      ...
      for (XincoCoreDataTypeAttribute
          xincoCoreDataTypeAttributeListXincoCoreDataTypeAttributeToAttach :
              xincoCoreDataType.getXincoCoreDataTypeAttributeList()) {
        xincoCoreDataTypeAttributeListXincoCoreDataTypeAttributeToAttach =
            em.getReference(
                org.hibernate.Hibernate.getClass(
                    xincoCoreDataTypeAttributeListXincoCoreDataTypeAttributeToAttach),
                xincoCoreDataTypeAttributeListXincoCoreDataTypeAttributeToAttach
                    .getXincoCoreDataTypeAttributePK());
        attachedXincoCoreDataTypeAttributeList.add(
            xincoCoreDataTypeAttributeListXincoCoreDataTypeAttributeToAttach);
      }
      ...
      for (XincoCoreData xincoCoreDataListXincoCoreDataToAttach :
          xincoCoreDataType.getXincoCoreDataList()) {
      ...
      for (XincoCoreDataTypeAttribute xincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute :
          xincoCoreDataType.getXincoCoreDataTypeAttributeList()) {
        XincoCoreDataType
            oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute =
                xincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute.getXincoCoreDataType();
        xincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute.setXincoCoreDataType(
            xincoCoreDataType);
        xincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute =
            em.merge(xincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute);
        if (oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute
            != null) {
          oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute
              .getXincoCoreDataTypeAttributeList()
              .remove(xincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute);
          oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute =
              em.merge(
                  oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListXincoCoreDataTypeAttribute);
        }
      ...
      for (XincoCoreData xincoCoreDataListXincoCoreData :
          xincoCoreDataType.getXincoCoreDataList()) {
        XincoCoreDataType oldXincoCoreDataTypeOfXincoCoreDataListXincoCoreData =
            xincoCoreDataListXincoCoreData.getXincoCoreDataType();
        ...
        if (oldXincoCoreDataTypeOfXincoCoreDataListXincoCoreData != null) {
          oldXincoCoreDataTypeOfXincoCoreDataListXincoCoreData
              .getXincoCoreDataList()
              .remove(xincoCoreDataListXincoCoreData);
          oldXincoCoreDataTypeOfXincoCoreDataListXincoCoreData =
              em.merge(oldXincoCoreDataTypeOfXincoCoreDataListXincoCoreData);
        }
      }
      ...
      if (findXincoCoreDataType(xincoCoreDataType.getId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreDataType " + xincoCoreDataType + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreDataType xincoCoreDataType)
      throws IllegalOrphanException, NonexistentEntityException, Exception {
    EntityManager em = null;
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreDataType persistentXincoCoreDataType =
          em.find(XincoCoreDataType.class, xincoCoreDataType.getId());
      List<XincoCoreDataTypeAttribute> xincoCoreDataTypeAttributeListOld =
          persistentXincoCoreDataType.getXincoCoreDataTypeAttributeList();
      List<XincoCoreDataTypeAttribute> xincoCoreDataTypeAttributeListNew =
          xincoCoreDataType.getXincoCoreDataTypeAttributeList();
      boolean xincoCoreDataTypeAttributeListNewInit =
          org.hibernate.Hibernate.isInitialized(xincoCoreDataTypeAttributeListNew);
      ...
      for (XincoCoreDataTypeAttribute xincoCoreDataTypeAttributeListOldXincoCoreDataTypeAttribute :
          xincoCoreDataTypeAttributeListOld) {
        if (xincoCoreDataTypeAttributeListNewInit
            && !xincoCoreDataTypeAttributeListNew.contains(
                xincoCoreDataTypeAttributeListOldXincoCoreDataTypeAttribute)) {
          if (illegalOrphanMessages == null) {
            illegalOrphanMessages = new ArrayList<>();
          }
          illegalOrphanMessages.add(
              "You must retain XincoCoreDataTypeAttribute "
                  + xincoCoreDataTypeAttributeListOldXincoCoreDataTypeAttribute
                  + " since its xincoCoreDataType field is not nullable.");
        }
      }
      ...
      List<XincoCoreDataTypeAttribute> attachedXincoCoreDataTypeAttributeListNew =
          new ArrayList<>();
      if (xincoCoreDataTypeAttributeListNewInit) {
        for (XincoCoreDataTypeAttribute
            xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttributeToAttach :
                xincoCoreDataTypeAttributeListNew) {
          xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttributeToAttach =
              em.getReference(
                  org.hibernate.Hibernate.getClass(
                      xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttributeToAttach),
                  xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttributeToAttach
                      .getXincoCoreDataTypeAttributePK());
          attachedXincoCoreDataTypeAttributeListNew.add(
              xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttributeToAttach);
        }
      }
      ...
      for (XincoCoreDataTypeAttribute xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute :
          xincoCoreDataTypeAttributeListNew) {
        if (!xincoCoreDataTypeAttributeListOld.contains(
            xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute)) {
          XincoCoreDataType
              oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute =
                  xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute
                      .getXincoCoreDataType();
          xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute.setXincoCoreDataType(
              xincoCoreDataType);
          xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute =
              em.merge(xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute);
          if (oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute
                  != null
              && !oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute
                  .equals(xincoCoreDataType)) {
            oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute
                .getXincoCoreDataTypeAttributeList()
                .remove(xincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute);
            oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute =
                em.merge(
                    oldXincoCoreDataTypeOfXincoCoreDataTypeAttributeListNewXincoCoreDataTypeAttribute);
          }
      ...
      for (XincoCoreData xincoCoreDataListNewXincoCoreData : xincoCoreDataListNew) {
        if (!xincoCoreDataListOld.contains(xincoCoreDataListNewXincoCoreData)) {
          XincoCoreDataType oldXincoCoreDataTypeOfXincoCoreDataListNewXincoCoreData =
              xincoCoreDataListNewXincoCoreData.getXincoCoreDataType();
          ...
          if (oldXincoCoreDataTypeOfXincoCoreDataListNewXincoCoreData != null
              && !oldXincoCoreDataTypeOfXincoCoreDataListNewXincoCoreData.equals(
                  xincoCoreDataType)) {
            oldXincoCoreDataTypeOfXincoCoreDataListNewXincoCoreData
                .getXincoCoreDataList()
                .remove(xincoCoreDataListNewXincoCoreData);
            oldXincoCoreDataTypeOfXincoCoreDataListNewXincoCoreData =
                em.merge(oldXincoCoreDataTypeOfXincoCoreDataListNewXincoCoreData);
          }
        }
      }
      em.getTransaction().commit();
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoCoreDataType(id) == null) {
          throw new NonexistentEntityException(
              "The xincoCoreDataType with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreDataType xincoCoreDataType = em.find(XincoCoreDataType.class, id);
      ...
      List<String> illegalOrphanMessages = null;
      List<XincoCoreDataTypeAttribute> xincoCoreDataTypeAttributeListOrphanCheck =
          xincoCoreDataType.getXincoCoreDataTypeAttributeList();
      for (XincoCoreDataTypeAttribute
          xincoCoreDataTypeAttributeListOrphanCheckXincoCoreDataTypeAttribute :
              xincoCoreDataTypeAttributeListOrphanCheck) {
        if (illegalOrphanMessages == null) {
          illegalOrphanMessages = new ArrayList<>();
        }
        illegalOrphanMessages.add(
            "This XincoCoreDataType ("
                + xincoCoreDataType
      ...
      for (XincoCoreData xincoCoreDataListOrphanCheckXincoCoreData : xincoCoreDataListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This XincoCoreDataType ("
                ...
                + " in its xincoCoreDataList field has a non-nullable xincoCoreDataType field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
  ...
  private List<XincoCoreDataType> findXincoCoreDataTypeEntities(
