...
public class XincoCoreDataTypeTJpaController implements Serializable {
  ...
  public void create(XincoCoreDataTypeT xincoCoreDataTypeT)
    ...
    try {
      ...
      if (findXincoCoreDataTypeT(xincoCoreDataTypeT.getRecordId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreDataTypeT " + xincoCoreDataTypeT + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreDataTypeT xincoCoreDataTypeT)
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoCoreDataTypeT(id) == null) {
          throw new NonexistentEntityException(
              "The xincoCoreDataTypeT with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws NonexistentEntityException {
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreDataTypeT xincoCoreDataTypeT = em.find(XincoCoreDataTypeT.class, id);

      if (xincoCoreDataTypeT == null) {
        throw new NonexistentEntityException(
            "The xincoCoreDataTypeT with id " + id + " no longer exists.");
      }
  ...
  private List<XincoCoreDataTypeT> findXincoCoreDataTypeTEntities(
