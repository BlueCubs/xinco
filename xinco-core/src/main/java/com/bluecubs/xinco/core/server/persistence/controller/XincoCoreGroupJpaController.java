 ...
 * ************************************************************
 *
 * Name: XincoCoreGroupJpaController
 *
...
public class XincoCoreGroupJpaController implements Serializable {
  ...
  public void create(XincoCoreGroup xincoCoreGroup) throws PreexistingEntityException, Exception {
    ...
    try {
      ...
      xincoCoreGroup.setXincoCoreUserHasXincoCoreGroupList(
      ...
      for (XincoCoreAce xincoCoreAceListXincoCoreAce : xincoCoreGroup.getXincoCoreAceList()) {
        XincoCoreGroup oldXincoCoreGroupOfXincoCoreAceListXincoCoreAce =
            xincoCoreAceListXincoCoreAce.getXincoCoreGroup();
        ...
        if (oldXincoCoreGroupOfXincoCoreAceListXincoCoreAce != null) {
          oldXincoCoreGroupOfXincoCoreAceListXincoCoreAce
              .getXincoCoreAceList()
              .remove(xincoCoreAceListXincoCoreAce);
          oldXincoCoreGroupOfXincoCoreAceListXincoCoreAce =
              em.merge(oldXincoCoreGroupOfXincoCoreAceListXincoCoreAce);
        }
      }
      for (XincoCoreUserHasXincoCoreGroup
          xincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup :
              xincoCoreGroup.getXincoCoreUserHasXincoCoreGroupList()) {
        XincoCoreGroup
            oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup =
                xincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup
                    .getXincoCoreGroup();
        xincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup.setXincoCoreGroup(
            xincoCoreGroup);
        xincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup =
            em.merge(xincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup);
        if (oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup
            != null) {
          oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListXincoCoreUserHasXincoCoreGroup
      ...
      if (findXincoCoreGroup(xincoCoreGroup.getId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreGroup " + xincoCoreGroup + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreGroup xincoCoreGroup)
      throws IllegalOrphanException, NonexistentEntityException, Exception {
    EntityManager em = null;
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreGroup persistentXincoCoreGroup =
        ...
        if (!xincoCoreUserHasXincoCoreGroupListNew.contains(
          ...
          illegalOrphanMessages.add(
              "You must retain XincoCoreUserHasXincoCoreGroup "
                  + xincoCoreUserHasXincoCoreGroupListOldXincoCoreUserHasXincoCoreGroup
                  + " since its xincoCoreGroup field is not nullable.");
        }
      }
      if (illegalOrphanMessages != null) {
      ...
      for (XincoCoreAce xincoCoreAceListNewXincoCoreAce : xincoCoreAceListNew) {
        if (!xincoCoreAceListOld.contains(xincoCoreAceListNewXincoCoreAce)) {
          XincoCoreGroup oldXincoCoreGroupOfXincoCoreAceListNewXincoCoreAce =
              xincoCoreAceListNewXincoCoreAce.getXincoCoreGroup();
          ...
          if (oldXincoCoreGroupOfXincoCoreAceListNewXincoCoreAce != null
              && !oldXincoCoreGroupOfXincoCoreAceListNewXincoCoreAce.equals(xincoCoreGroup)) {
            oldXincoCoreGroupOfXincoCoreAceListNewXincoCoreAce
                .getXincoCoreAceList()
                .remove(xincoCoreAceListNewXincoCoreAce);
            oldXincoCoreGroupOfXincoCoreAceListNewXincoCoreAce =
                em.merge(oldXincoCoreGroupOfXincoCoreAceListNewXincoCoreAce);
          }
        }
      }
      for (XincoCoreUserHasXincoCoreGroup
        ...
        if (!xincoCoreUserHasXincoCoreGroupListOld.contains(
            xincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup)) {
          XincoCoreGroup
              oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup =
                  xincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup
                      .getXincoCoreGroup();
          xincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup.setXincoCoreGroup(
              xincoCoreGroup);
          xincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup =
              em.merge(xincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup);
          if (oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup
                  != null
              && !oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup
                  .equals(xincoCoreGroup)) {
            oldXincoCoreGroupOfXincoCoreUserHasXincoCoreGroupListNewXincoCoreUserHasXincoCoreGroup
                .getXincoCoreUserHasXincoCoreGroupList()
  ...
  private List<XincoCoreGroup> findXincoCoreGroupEntities(
