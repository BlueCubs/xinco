...
public class XincoCoreLanguageTJpaController implements Serializable {
  ...
  public void create(XincoCoreLanguageT xincoCoreLanguageT)
    ...
    try {
      ...
      if (findXincoCoreLanguageT(xincoCoreLanguageT.getRecordId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreLanguageT " + xincoCoreLanguageT + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreLanguageT xincoCoreLanguageT)
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoCoreLanguageT(id) == null) {
          throw new NonexistentEntityException(
              "The xincoCoreLanguageT with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws NonexistentEntityException {
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreLanguageT xincoCoreLanguageT = em.find(XincoCoreLanguageT.class, id);

      if (xincoCoreLanguageT == null) {
        throw new NonexistentEntityException(
            "The xincoCoreLanguageT with id " + id + " no longer exists.");
      }
  ...
  private List<XincoCoreLanguageT> findXincoCoreLanguageTEntities(
