...
public class XincoCoreNodeJpaController implements Serializable {
  ...
  public void create(XincoCoreNode xincoCoreNode) throws PreexistingEntityException, Exception {
    ...
    try {
      ...
      for (XincoCoreNode xincoCoreNodeListXincoCoreNode : xincoCoreNode.getXincoCoreNodeList()) {
        XincoCoreNode oldXincoCoreNodeOfXincoCoreNodeListXincoCoreNode =
            xincoCoreNodeListXincoCoreNode.getXincoCoreNode();
        ...
        if (oldXincoCoreNodeOfXincoCoreNodeListXincoCoreNode != null) {
          oldXincoCoreNodeOfXincoCoreNodeListXincoCoreNode
              .getXincoCoreNodeList()
              .remove(xincoCoreNodeListXincoCoreNode);
          oldXincoCoreNodeOfXincoCoreNodeListXincoCoreNode =
              em.merge(oldXincoCoreNodeOfXincoCoreNodeListXincoCoreNode);
        }
      }
      for (XincoCoreAce xincoCoreAceListXincoCoreAce : xincoCoreNode.getXincoCoreAceList()) {
        XincoCoreNode oldXincoCoreNodeOfXincoCoreAceListXincoCoreAce =
            xincoCoreAceListXincoCoreAce.getXincoCoreNode();
        ...
        if (oldXincoCoreNodeOfXincoCoreAceListXincoCoreAce != null) {
          oldXincoCoreNodeOfXincoCoreAceListXincoCoreAce
              .getXincoCoreAceList()
              .remove(xincoCoreAceListXincoCoreAce);
          oldXincoCoreNodeOfXincoCoreAceListXincoCoreAce =
              em.merge(oldXincoCoreNodeOfXincoCoreAceListXincoCoreAce);
        }
      }
      for (XincoCoreData xincoCoreDataListXincoCoreData : xincoCoreNode.getXincoCoreDataList()) {
        XincoCoreNode oldXincoCoreNodeOfXincoCoreDataListXincoCoreData =
            xincoCoreDataListXincoCoreData.getXincoCoreNode();
        ...
        if (oldXincoCoreNodeOfXincoCoreDataListXincoCoreData != null) {
          oldXincoCoreNodeOfXincoCoreDataListXincoCoreData
              .getXincoCoreDataList()
              .remove(xincoCoreDataListXincoCoreData);
          oldXincoCoreNodeOfXincoCoreDataListXincoCoreData =
              em.merge(oldXincoCoreNodeOfXincoCoreDataListXincoCoreData);
        }
      }
      ...
      if (findXincoCoreNode(xincoCoreNode.getId()) != null) {
        throw new PreexistingEntityException(
            "XincoCoreNode " + xincoCoreNode + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreNode xincoCoreNode)
    ...
    try {
        ...
        if (!xincoCoreDataListNew.contains(xincoCoreDataListOldXincoCoreData)) {
          ...
          illegalOrphanMessages.add(
              "You must retain XincoCoreData "
                  ...
                  + " since its xincoCoreNode field is not nullable.");
        }
      }
      if (illegalOrphanMessages != null) {
      ...
      for (XincoCoreNode xincoCoreNodeListNewXincoCoreNode : xincoCoreNodeListNew) {
        if (!xincoCoreNodeListOld.contains(xincoCoreNodeListNewXincoCoreNode)) {
          XincoCoreNode oldXincoCoreNodeOfXincoCoreNodeListNewXincoCoreNode =
              xincoCoreNodeListNewXincoCoreNode.getXincoCoreNode();
          ...
          if (oldXincoCoreNodeOfXincoCoreNodeListNewXincoCoreNode != null
              && !oldXincoCoreNodeOfXincoCoreNodeListNewXincoCoreNode.equals(xincoCoreNode)) {
            oldXincoCoreNodeOfXincoCoreNodeListNewXincoCoreNode
                .getXincoCoreNodeList()
                .remove(xincoCoreNodeListNewXincoCoreNode);
            oldXincoCoreNodeOfXincoCoreNodeListNewXincoCoreNode =
                em.merge(oldXincoCoreNodeOfXincoCoreNodeListNewXincoCoreNode);
          }
        }
      }
      ...
      for (XincoCoreAce xincoCoreAceListNewXincoCoreAce : xincoCoreAceListNew) {
        if (!xincoCoreAceListOld.contains(xincoCoreAceListNewXincoCoreAce)) {
          XincoCoreNode oldXincoCoreNodeOfXincoCoreAceListNewXincoCoreAce =
              xincoCoreAceListNewXincoCoreAce.getXincoCoreNode();
          ...
          if (oldXincoCoreNodeOfXincoCoreAceListNewXincoCoreAce != null
              && !oldXincoCoreNodeOfXincoCoreAceListNewXincoCoreAce.equals(xincoCoreNode)) {
            oldXincoCoreNodeOfXincoCoreAceListNewXincoCoreAce
                .getXincoCoreAceList()
                .remove(xincoCoreAceListNewXincoCoreAce);
            oldXincoCoreNodeOfXincoCoreAceListNewXincoCoreAce =
                em.merge(oldXincoCoreNodeOfXincoCoreAceListNewXincoCoreAce);
          }
        }
      }
      for (XincoCoreData xincoCoreDataListNewXincoCoreData : xincoCoreDataListNew) {
        if (!xincoCoreDataListOld.contains(xincoCoreDataListNewXincoCoreData)) {
          XincoCoreNode oldXincoCoreNodeOfXincoCoreDataListNewXincoCoreData =
              xincoCoreDataListNewXincoCoreData.getXincoCoreNode();
          ...
          if (oldXincoCoreNodeOfXincoCoreDataListNewXincoCoreData != null
              && !oldXincoCoreNodeOfXincoCoreDataListNewXincoCoreData.equals(xincoCoreNode)) {
            oldXincoCoreNodeOfXincoCoreDataListNewXincoCoreData
                .getXincoCoreDataList()
                .remove(xincoCoreDataListNewXincoCoreData);
            oldXincoCoreNodeOfXincoCoreDataListNewXincoCoreData =
                em.merge(oldXincoCoreNodeOfXincoCoreDataListNewXincoCoreData);
          }
        }
      }
      em.getTransaction().commit();
      ...
      for (XincoCoreData xincoCoreDataListOrphanCheckXincoCoreData : xincoCoreDataListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This XincoCoreNode ("
                ...
                + " in its xincoCoreDataList field has a non-nullable xincoCoreNode field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
  ...
  private List<XincoCoreNode> findXincoCoreNodeEntities(
