...
public class XincoCoreUserHasXincoCoreGroupJpaController implements Serializable {
  ...
  public void create(XincoCoreUserHasXincoCoreGroup xincoCoreUserHasXincoCoreGroup)
      throws PreexistingEntityException, Exception {
    if (xincoCoreUserHasXincoCoreGroup.getXincoCoreUserHasXincoCoreGroupPK() == null) {
      xincoCoreUserHasXincoCoreGroup.setXincoCoreUserHasXincoCoreGroupPK(
          new XincoCoreUserHasXincoCoreGroupPK());
    }
    xincoCoreUserHasXincoCoreGroup
        .getXincoCoreUserHasXincoCoreGroupPK()
        .setXincoCoreGroupId(xincoCoreUserHasXincoCoreGroup.getXincoCoreGroup().getId());
    xincoCoreUserHasXincoCoreGroup
        .getXincoCoreUserHasXincoCoreGroupPK()
        .setXincoCoreUserId(xincoCoreUserHasXincoCoreGroup.getXincoCoreUser().getId());
    ...
    try {
      ...
      if (findXincoCoreUserHasXincoCoreGroup(
              xincoCoreUserHasXincoCoreGroup.getXincoCoreUserHasXincoCoreGroupPK())
          != null) {
        throw new PreexistingEntityException(
            "XincoCoreUserHasXincoCoreGroup " + xincoCoreUserHasXincoCoreGroup + " already exists.",
            ex);
      }
      throw ex;
    } finally {
  ...
  public void edit(XincoCoreUserHasXincoCoreGroup xincoCoreUserHasXincoCoreGroup)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreUserHasXincoCoreGroup persistentXincoCoreUserHasXincoCoreGroup =
          em.find(
              XincoCoreUserHasXincoCoreGroup.class,
              xincoCoreUserHasXincoCoreGroup.getXincoCoreUserHasXincoCoreGroupPK());
      ...
      XincoCoreGroup xincoCoreGroupOld =
          persistentXincoCoreUserHasXincoCoreGroup.getXincoCoreGroup();
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoCoreUserHasXincoCoreGroup(id) == null) {
          throw new NonexistentEntityException(
              "The xincoCoreUserHasXincoCoreGroup with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(XincoCoreUserHasXincoCoreGroupPK id) throws NonexistentEntityException {
    ...
    try {
      ...
      XincoCoreUserHasXincoCoreGroup xincoCoreUserHasXincoCoreGroup =
          em.find(XincoCoreUserHasXincoCoreGroup.class, id);

      if (xincoCoreUserHasXincoCoreGroup == null) {
        throw new NonexistentEntityException(
            "The xincoCoreUserHasXincoCoreGroup with id " + id + " no longer exists.");
      }
      XincoCoreUser xincoCoreUser = xincoCoreUserHasXincoCoreGroup.getXincoCoreUser();
  ...
  private List<XincoCoreUserHasXincoCoreGroup> findXincoCoreUserHasXincoCoreGroupEntities(
  ...
  public XincoCoreUserHasXincoCoreGroup findXincoCoreUserHasXincoCoreGroup(
      XincoCoreUserHasXincoCoreGroupPK id) {
    EntityManager em = getEntityManager();
    try {
