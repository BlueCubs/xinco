 ...
 * ************************************************************
 *
 * Name: XincoCoreUserHasXincoCoreGroupTJpaController
 *
...
public class XincoCoreUserHasXincoCoreGroupTJpaController implements Serializable {
  ...
  public void create(XincoCoreUserHasXincoCoreGroupT xincoCoreUserHasXincoCoreGroupT)
    ...
    try {
      ...
      if (findXincoCoreUserHasXincoCoreGroupT(xincoCoreUserHasXincoCoreGroupT.getRecordId())
          != null) {
  ...
  public void edit(XincoCoreUserHasXincoCoreGroupT xincoCoreUserHasXincoCoreGroupT)
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoCoreUserHasXincoCoreGroupT(id) == null) {
          throw new NonexistentEntityException(
              "The xincoCoreUserHasXincoCoreGroupT with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws NonexistentEntityException {
    ...
    try {
      ...
      try {
        xincoCoreUserHasXincoCoreGroupT =
            em.getReference(XincoCoreUserHasXincoCoreGroupT.class, id);
        xincoCoreUserHasXincoCoreGroupT.getRecordId();
      } catch (EntityNotFoundException enfe) {
        throw new NonexistentEntityException(
            "The xincoCoreUserHasXincoCoreGroupT with id " + id + " no longer exists.", enfe);
      }
  ...
  private List<XincoCoreUserHasXincoCoreGroupT> findXincoCoreUserHasXincoCoreGroupTEntities(
