...
public class XincoCoreUserModifiedRecordJpaController implements Serializable {
  ...
  public void create(XincoCoreUserModifiedRecord xincoCoreUserModifiedRecord)
      throws PreexistingEntityException, Exception {
    if (xincoCoreUserModifiedRecord.getXincoCoreUserModifiedRecordPK() == null) {
      xincoCoreUserModifiedRecord.setXincoCoreUserModifiedRecordPK(
          new XincoCoreUserModifiedRecordPK());
    }
    xincoCoreUserModifiedRecord
        .getXincoCoreUserModifiedRecordPK()
        .setId(xincoCoreUserModifiedRecord.getXincoCoreUser().getId());
    ...
    try {
      ...
      if (findXincoCoreUserModifiedRecord(
              xincoCoreUserModifiedRecord.getXincoCoreUserModifiedRecordPK())
          != null) {
        throw new PreexistingEntityException(
            "XincoCoreUserModifiedRecord " + xincoCoreUserModifiedRecord + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoCoreUserModifiedRecord xincoCoreUserModifiedRecord)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoCoreUserModifiedRecord persistentXincoCoreUserModifiedRecord =
          em.find(
              XincoCoreUserModifiedRecord.class,
              xincoCoreUserModifiedRecord.getXincoCoreUserModifiedRecordPK());
      ...
      if (msg == null || msg.length() == 0) {
        XincoCoreUserModifiedRecordPK id =
            xincoCoreUserModifiedRecord.getXincoCoreUserModifiedRecordPK();
  ...
  private List<XincoCoreUserModifiedRecord> findXincoCoreUserModifiedRecordEntities(
  ...
  public XincoCoreUserModifiedRecord findXincoCoreUserModifiedRecord(
      XincoCoreUserModifiedRecordPK id) {
    EntityManager em = getEntityManager();
    try {
