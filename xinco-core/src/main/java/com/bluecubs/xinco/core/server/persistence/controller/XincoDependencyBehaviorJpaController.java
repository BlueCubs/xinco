...
public class XincoDependencyBehaviorJpaController implements Serializable {
  ...
  public void create(XincoDependencyBehavior xincoDependencyBehavior) {
    ...
    try {
      ...
      for (XincoDependencyType xincoDependencyTypeListXincoDependencyTypeToAttach :
      ...
      for (XincoDependencyType xincoDependencyTypeListXincoDependencyType :
          xincoDependencyBehavior.getXincoDependencyTypeList()) {
        XincoDependencyBehavior
            oldXincoDependencyBehaviorOfXincoDependencyTypeListXincoDependencyType =
                xincoDependencyTypeListXincoDependencyType.getXincoDependencyBehavior();
        xincoDependencyTypeListXincoDependencyType.setXincoDependencyBehavior(
            xincoDependencyBehavior);
        xincoDependencyTypeListXincoDependencyType =
            em.merge(xincoDependencyTypeListXincoDependencyType);
        if (oldXincoDependencyBehaviorOfXincoDependencyTypeListXincoDependencyType != null) {
          oldXincoDependencyBehaviorOfXincoDependencyTypeListXincoDependencyType
              .getXincoDependencyTypeList()
              .remove(xincoDependencyTypeListXincoDependencyType);
          oldXincoDependencyBehaviorOfXincoDependencyTypeListXincoDependencyType =
              em.merge(oldXincoDependencyBehaviorOfXincoDependencyTypeListXincoDependencyType);
        }
      }
  ...
  public void edit(XincoDependencyBehavior xincoDependencyBehavior)
      throws IllegalOrphanException, NonexistentEntityException, Exception {
    EntityManager em = null;
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoDependencyBehavior persistentXincoDependencyBehavior =
          em.find(XincoDependencyBehavior.class, xincoDependencyBehavior.getId());
      List<XincoDependencyType> xincoDependencyTypeListOld =
      ...
      for (XincoDependencyType xincoDependencyTypeListOldXincoDependencyType :
        ...
        if (!xincoDependencyTypeListNew.contains(xincoDependencyTypeListOldXincoDependencyType)) {
          ...
          illegalOrphanMessages.add(
              "You must retain XincoDependencyType "
                  + xincoDependencyTypeListOldXincoDependencyType
                  + " since its xincoDependencyBehavior field is not nullable.");
        }
      }
      if (illegalOrphanMessages != null) {
      ...
      for (XincoDependencyType xincoDependencyTypeListNewXincoDependencyType :
          xincoDependencyTypeListNew) {
        if (!xincoDependencyTypeListOld.contains(xincoDependencyTypeListNewXincoDependencyType)) {
          XincoDependencyBehavior
              oldXincoDependencyBehaviorOfXincoDependencyTypeListNewXincoDependencyType =
                  xincoDependencyTypeListNewXincoDependencyType.getXincoDependencyBehavior();
          xincoDependencyTypeListNewXincoDependencyType.setXincoDependencyBehavior(
              xincoDependencyBehavior);
          xincoDependencyTypeListNewXincoDependencyType =
              em.merge(xincoDependencyTypeListNewXincoDependencyType);
          if (oldXincoDependencyBehaviorOfXincoDependencyTypeListNewXincoDependencyType != null
              && !oldXincoDependencyBehaviorOfXincoDependencyTypeListNewXincoDependencyType.equals(
                  xincoDependencyBehavior)) {
            oldXincoDependencyBehaviorOfXincoDependencyTypeListNewXincoDependencyType
                .getXincoDependencyTypeList()
                .remove(xincoDependencyTypeListNewXincoDependencyType);
            oldXincoDependencyBehaviorOfXincoDependencyTypeListNewXincoDependencyType =
                em.merge(oldXincoDependencyBehaviorOfXincoDependencyTypeListNewXincoDependencyType);
          }
        }
      }
      em.getTransaction().commit();
  ...
  public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
    ...
    try {
      ...
      List<XincoDependencyType> xincoDependencyTypeListOrphanCheck =
          xincoDependencyBehavior.getXincoDependencyTypeList();
      for (XincoDependencyType xincoDependencyTypeListOrphanCheckXincoDependencyType :
          xincoDependencyTypeListOrphanCheck) {
        if (illegalOrphanMessages == null) {
          illegalOrphanMessages = new ArrayList<>();
        }
        illegalOrphanMessages.add(
            "This XincoDependencyBehavior ("
                + xincoDependencyBehavior
  ...
  private List<XincoDependencyBehavior> findXincoDependencyBehaviorEntities(
