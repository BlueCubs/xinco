...
public class XincoDependencyBehaviorTJpaController implements Serializable {
  ...
  public void create(XincoDependencyBehaviorT xincoDependencyBehaviorT)
    ...
    try {
      ...
      if (findXincoDependencyBehaviorT(xincoDependencyBehaviorT.getRecordId()) != null) {
        throw new PreexistingEntityException(
            "XincoDependencyBehaviorT " + xincoDependencyBehaviorT + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoDependencyBehaviorT xincoDependencyBehaviorT)
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoDependencyBehaviorT(id) == null) {
          throw new NonexistentEntityException(
              "The xincoDependencyBehaviorT with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws NonexistentEntityException {
    ...
    try {
      ...
      XincoDependencyBehaviorT xincoDependencyBehaviorT =
          em.find(XincoDependencyBehaviorT.class, id);

      if (xincoDependencyBehaviorT == null) {
        throw new NonexistentEntityException(
            "The xincoDependencyBehaviorT with id " + id + " no longer exists.");
      }
  ...
  private List<XincoDependencyBehaviorT> findXincoDependencyBehaviorTEntities(
