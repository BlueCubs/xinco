...
public class XincoDependencyTypeTJpaController implements Serializable {
    ...
    try {
      ...
      if (findXincoDependencyTypeT(xincoDependencyTypeT.getRecordId()) != null) {
        throw new PreexistingEntityException(
            "XincoDependencyTypeT " + xincoDependencyTypeT + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(XincoDependencyTypeT xincoDependencyTypeT)
      ...
      if (msg == null || msg.length() == 0) {
        ...
        if (findXincoDependencyTypeT(id) == null) {
          throw new NonexistentEntityException(
              "The xincoDependencyTypeT with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws NonexistentEntityException {
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      XincoDependencyTypeT xincoDependencyTypeT = em.find(XincoDependencyTypeT.class, id);

      if (xincoDependencyTypeT == null) {
        throw new NonexistentEntityException(
            "The xincoDependencyTypeT with id " + id + " no longer exists.");
      }
  ...
  private List<XincoDependencyTypeT> findXincoDependencyTypeTEntities(
