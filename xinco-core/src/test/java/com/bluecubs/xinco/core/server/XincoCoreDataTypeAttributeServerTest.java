...
public class XincoCoreDataTypeAttributeServerTest extends AbstractXincoDataBaseTestCase {
  ...
  public void testWrite2DB() {
    try {
      XincoCoreDataTypeAttribute findXincoCoreDataTypeAttribute =
          new XincoCoreDataTypeAttributeJpaController(getEntityManagerFactory())
              .findXincoCoreDataTypeAttribute(new XincoCoreDataTypeAttributePK(1, 20));
      if (findXincoCoreDataTypeAttribute != null) {
        new XincoCoreDataTypeAttributeJpaController(getEntityManagerFactory())
            .destroy(findXincoCoreDataTypeAttribute.getXincoCoreDataTypeAttributePK());
      }
      XincoCoreDataTypeAttributeServer instance =
          new XincoCoreDataTypeAttributeServer(1, 20, "Test", "Test", 1);
