...
function ou() {
  ...
  return Array.from(document.body.querySelectorAll("*")).flatMap(Bs).filter(zs).filter((n) => !n.fileName.includes("frontend/generated/")).forEach((n) => e.add(n.fileName)), Array.from(e);
}
function zs(e) {
  return !!e && e.fileName;
}
...
const hn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), ve = "copilot-", Xs = "24.7.4", au = "attention-required", su = "https://plugins.jetbrains.com/plugin/23758-vaadin", lu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function cu(e) {
...
function vn(e) {
  Promise.resolve().then(() => nc).then(({ showNotification: t }) => {
    t(e);
  });
}
function nl() {
...
function rl(e) {
  return e.children && (e.children = e.children.filter(rl)), e.visible !== !1;
}
async function no() {
  return eo(() => {
...
const gu = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, al = (e) => {
  const t = [];
  let n = ll(e);
  for (; n; )
...
function fl(e, t) {
  const n = ul(e), r = n.getBoundingClientRect();
...
function bu(e) {
  const t = ro(e), n = sl(t);
  !t.every((i) => dl(i, n)) && t.length > 0 && t[0].scrollIntoView();
}
function ro(e) {
  const t = e;
  if (!t)
...
class pl {
  ...
  addRecentSwitchedUsername(t) {
    this.setRecentSwitchedUsernames(tl([t, ...this.recentSwitchedUsernames]));
  }
...
class gl {
  ...
  loadPreviewConfiguration() {
    hn(`${ve}get-preview`, {}, (t) => {
      ...
      Promise.resolve().then(() => hc).then((n) => {
...
window.Vaadin.copilot._uiState = new ol();
window.Vaadin.copilot.eventbus = new Vo();
window.Vaadin.copilot.overlayManager = new vl();
window.Vaadin.copilot._machineState = new pl();
window.Vaadin.copilot._storedProjectState = new _l();
window.Vaadin.copilot._previewState = new gl();
window.Vaadin.copilot._sectionPanelUiState = new ml();
window.Vaadin.copilot._earlyProjectState = new bl();
/**
 * @license
...
const J = (e) => new co(typeof e == "string" ? e : e + "", void 0, rr), wl = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ol, defineProperty: Al, getOwnPropertyDescriptor: Sl, getOwnPropertyNames: xl, getOwnPropertySymbols: Nl, getPrototypeOf: Cl } = Object, pn = globalThis, Ir = pn.trustedTypes, Pl = Ir ? Ir.emptyScript : "", $l = pn.reactiveElementPolyfillSupport, ft = (e, t) => e, Un = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Pl : null;
      break;
  ...
  return n;
} }, uo = (e, t) => !Ol(e, t), Vr = { attribute: !0, type: String, converter: Un, reflect: !1, hasChanged: uo };
...
let Me = class extends HTMLElement {
  ...
  static createProperty(t, n = Vr) {
    if (n.state && (n.attribute = !1), this._$Ei(), this.elementProperties.set(t, n), !n.noAccessor) {
      ...
      i !== void 0 && Al(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, n, r) {
    const { get: i, set: o } = Sl(this.prototype, t) ?? { get() {
      return this[n];
    }, set(a) {
      this[n] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ft("properties"))) {
      const n = this.properties, r = [...xl(n), ...Nl(n)];
...
Me.elementStyles = [], Me.shadowRootOptions = { mode: "open" }, Me[ft("elementProperties")] = /* @__PURE__ */ new Map(), Me[ft("finalized")] = /* @__PURE__ */ new Map(), $l?.({ ReactiveElement: Me }), (pn.reactiveElementVersions ??= []).push("2.0.4");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ir = globalThis, en = ir.trustedTypes, jr = en ? en.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, fo = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, ho = "?" + ue, kl = `<${ho}>`, De = document, yt = () => De.createComment(""), wt = (e) => e === null || typeof e != "object" && typeof e != "function", or = Array.isArray, Il = (e) => or(e) || typeof e?.[Symbol.iterator] == "function", An = `[ 	
...
const Vl = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    ...
    o += a === rt ? l + kl : d >= 0 ? (r.push(c), l.slice(0, d) + fo + l.slice(d) + ue + p) : l + ue + (d === -2 ? s : p);
  }
...
class Et {
  constructor({ strings: t, _$litType$: n }, r) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const s = t.length - 1, l = this.parts, [c, u] = Vl(t, n);
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(fo)) {
          ...
          l.push({ type: 1, index: o, name: b[2], strings: p, ctor: b[1] === "." ? jl : b[1] === "?" ? Ml : b[1] === "@" ? Ll : gn }), i.removeAttribute(d);
...
let Rl = class {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new Qe(o, o.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (c = new zl(o, this, t)), this._$AV.push(c), l = r[++s];
      }
...
class Qe {
  ...
  _$AI(t, n = this) {
    t = We(this, t, n), wt(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== pe && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Il(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    ...
    if (this._$AH?._$AD === i) this._$AH.p(n);
      ...
      const o = new Rl(i, this), a = o.u(this.options);
...
const Ul = { I: Qe }, Bl = ir.litHtmlPolyfillSupport;
Bl?.(Et, Qe), (ir.litHtmlVersions ??= []).push("3.2.1");
const Fl = (e, t, n) => {
...
let ht = class extends Me {
  ...
  update(t) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Fl(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
function Wl() {
  Ee.push(import("./copilot-log-plugin--2coQMYk.js")), Ee.push(import("./copilot-info-plugin-BFNiPsoX.js")), Ee.push(import("./copilot-features-plugin-BnFkd0D8.js")), Ee.push(import("./copilot-feedback-plugin-BT-OHkQh.js")), Ee.push(import("./copilot-shortcuts-plugin-05QAUjvA.js"));
}
function Gl() {
  {
...
const It = new Xl(), y = window.Vaadin.copilot.eventbus;
if (!y)
...
const Yl = bo(Bn), Ct = window.Vaadin.copilot._machineState;
if (!Ct)
  throw new Error("Trying to use stored machine state before it was initialized");
const Zl = 5e3;
let Kr = 1;
function yo(e) {
  g.notifications.includes(e) && (e.dontShowAgain && e.dismissId && Ql(e.dismissId), g.removeNotification(e), y.emit("notification-dismissed", e));
}
function wo(e) {
...
function tc(e) {
  ...
  g.setNotifications([...g.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    yo(n);
  }, e.delay ?? Zl), y.emit("notification-shown", e);
}
...
const oc = async () => eo(() => g.userInfo), Nu = async () => (await oc()).vaadiner;
function ac() {
  const e = g.userInfo;
...
}, lc = (e, t) => e.error ? (cc(e.error, t), !0) : !1, Ao = (e, t, n, r) => {
  vn({
    type: Ve.ERROR,
    message: e,
    details: to(
      Ue`<vaadin-details summary="Details" style="color: var(--dev-tools-text-color)"
        ><div>
          <code class="codeblock"><copilot-copy></copilot-copy>${Yl(t)}</code>
          <vaadin-button hidden>Report this issue</vaadin-button>
        </div></vaadin-details
      >`
    ),
    delay: 3e4
  }), ac() && y.emit("system-info-with-callback", {
...
${n}` : "")
  ...
  Sn(t) && t.suggestRestart && rc() && (r.details = to(
    Ue`${e}<br />${n}
        <button
          style="align-self:start;padding:0"
          @click=${(o) => {
      const a = o.target;
      a.disabled = !0, a.innerText = "Restarting...", ic();
    }}>
          Restart now
        </button>`
  ), r.delay = 3e4), vn(r);
  ...
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Ve.ERROR, message: n.map((r) => dc(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function dc(e) {
...
const hc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  handleBrowserOperationError: uc,
  handleCopilotError: le,
  handleErrorDuringOperation: sc,
  handleServerOperationErrorIfNeeded: lc,
  installErrorHandlers: So,
  showNotReactFlowProject: fc
}, Symbol.toStringTag, { value: "Module" })), No = () => {
  vc().then((e) => g.setUserInfo(e)).catch((e) => le("Failed to load userInfo", e));
}, vc = async () => hn(`${ve}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Co = Symbol.for(""), pc = (e) => {
  if (e?.r === Co) return e?._$litStatic$;
}, Po = (e) => ({ _$litStatic$: e, r: Co }), Wr = /* @__PURE__ */ new Map(), gc = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
  for (; c < r; ) {
    for (l = t[c]; c < r && (o = n[c], (i = pc(o)) !== void 0); ) l += i + t[++c], u = !0;
...
const { I: mc } = Ul, Cu = (e) => e.strings === void 0, Gr = () => document.createComment(""), at = (e, t, n) => {
  ...
  return n;
}, we = (e, t, n = e) => (e._$AI(t, n), e), bc = {}, _c = (e, t = bc) => e._$AH = t, yc = (e) => e._$AH, xn = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Jr = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    const i = yc(e), { values: o, keys: a } = this.dt(t, n, r);
    ...
    return this.ut = a, _c(e, l), pe;
  }
}), Lt = /* @__PURE__ */ new Map(), wc = (e) => {
...
const xc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Xr = { randomUUID: xc };
function Do(e, t, n) {
  if (Xr.randomUUID && !e)
    return Xr.randomUUID();
  e = e || {};
  const r = e.random ?? e.rng?.() ?? Sc();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, Oc(r);
}
...
const Zr = new Bc(), Fc = "copilot-development-setup-user-guide";
function Iu() {
  _t("use-dev-workflow-guide"), se.updatePanel(Fc, { floating: !0 });
}
function Io() {
  const e = g.jdkInfo;
...
const ni = (e) => {
  ...
  let i = !0, o = !1;
  ti(e) ? i = !1 : e.key === "Escape" ? g.loginCheckActive ? g.setLoginCheckActive(!1) : y.emit("close-drawers", {}) : Qc(e) ? (y.emit("delete-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "d" ? (y.emit("duplicate-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "b" ? (y.emit("show-selected-in-ide", { attach: e.shiftKey }), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "z" && Zc() ? (y.emit("undoRedo", { undo: !e.shiftKey }), o = !0) : ti(e) || y.emit("keyboard-event", { event: e }), i && e.stopPropagation(), o && e.preventDefault();
}, Qc = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, ne = Xc(), Rt = "⇧", ju = {
...
var eu = Object.getOwnPropertyDescriptor, tu = (e, t, n, r) => {
  for (var i = r > 1 ? void 0 : r ? eu(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = a(i) || i);
  return i;
};
let ri = class extends ql {
  constructor() {
    ...
    }, this.operationInProgressCursorUpdateDebounceFunc = Uc(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-B6t8DVTk.js"), await import("./copilot-init-step2-CJjhlb41.js"), il(), Wl(), this.tabIndex = 0, It.hostConnectedCallback(), window.addEventListener("keydown", Hn), this.addEventListener("keydown", ni), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), So(), this.initialized = !0, Kc();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    It.activate(), Zr.copilotActivated(), Jl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.addEventListener("mouseover", this.mouseOverListener), ot.onCopilotActivation(), await Wc(), Oo.loadPreviewConfiguration(), this.active = !0;
  }
  /**
  ...
  render() {
    return Ue`
      ...
      ${this.renderDrawer("left")} ${this.renderDrawer("right")} ${this.renderDrawer("bottom")} ${Ec()}
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), Cc();
  }
