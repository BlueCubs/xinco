import { a as V, ah as U, J as C, a2 as H, L as z, j as u, w as N, F as c, E as j, ai as I, Q as J, W as O, T as L, M as B, v as W, b as q, u as P } from "./copilot-D0Z2-8TG.js";
import { r as A } from "./state-CBOKMTMT.js";
import { B as F } from "./base-panel-D-St23hK.js";
import { i as b } from "./icons-Bm90QnWr.js";
...
let y = class extends F {
  constructor() {
    super(...arguments), this.serverInfo = [], this.clientInfo = [{ name: "Browser", version: navigator.userAgent }], this.handleServerInfoEvent = (e) => {
      ...
      }), C() === "success" && H("hotswap-active", { value: z() });
    };
  }
  connectedCallback() {
  ...
  render() {
    ...
    return l && (l.more = c`<button
        ...
        @click="${(n) => {
      n.stopPropagation(), N.updatePanel("copilot-vaadin-versions", { floating: !0 });
    }}">
        Upgrade
