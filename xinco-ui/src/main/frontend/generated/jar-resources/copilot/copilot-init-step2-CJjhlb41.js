import { u as y, v as I, b as g, j as r, C as J, w as c, x as Se, y as S, z as X, A as L, O as re, B as A, D as p, F as l, G as ke, H as je, I as Be, J as G, K as ge, E as u, L as Ne, k as De, l as Je, P as Ve, N as Fe, V as qe, Q as Re, R as $, S as Xe, T as Y, M as W, U as le, W as Ye, X as V, Y as We, Z as fe, _ as Ee, $ as Ge, a0 as Ke, a1 as Ze, a2 as Qe, a3 as et, a4 as tt, a5 as it, a6 as nt, a7 as ot, a8 as st, a9 as at, aa as ze, ab as rt, ac as de, ad as lt } from "./copilot-D0Z2-8TG.js";
import { n as R, r as C } from "./state-CBOKMTMT.js";
import { e as M, m as ce } from "./overlay-monkeypatch-CJ80DYS6.js";
import { i as d } from "./icons-Bm90QnWr.js";
...
function pt(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? me : (t.offsetHeight - (t.position === "bottom" ? ct : 0) - o * me - i * dt) / n;
  });
}
var ut = Object.defineProperty, gt = Object.getOwnPropertyDescriptor, _ = (e, t, i, n) => {
...
let k = class extends I {
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      (t) => {
        t === re.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
  ...
  cleanUpDragging() {
    this.draggingSectionPanel && (r.setSectionPanelDragging(!1), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
      e.style.removeProperty("transform"), e.removeAttribute(j), e.removeAttribute(K);
...
var ft = Object.defineProperty, mt = Object.getOwnPropertyDescriptor, Le = (e, t, i, n) => {
...
class vt {
  ...
  adjust(t, i, n, o, s) {
    ...
    return (o + i) / 2 < x / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), v = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${x - o}px`), a = void 0, v = Math.max(0, x - o)), (n + s) / 2 < U / 2 ? (t.style.setProperty("--top", `${n}px`), t.style.setProperty("--bottom", ""), m = void 0, h = Math.max(0, n)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${U - s}px`), h = void 0, m = Math.max(0, U - s)), {
      left: a,
      right: v,
      top: h,
      bottom: m
...
const P = new vt();
var bt = Object.defineProperty, wt = Object.getOwnPropertyDescriptor, T = (e, t, i, n) => {
...
let w = class extends I {
  ...
  render() {
    ...
    return l`
      ...
      <div part="footer">
        <vaadin-button
          id="close"
          @click="${() => c.updatePanel(he.tag, { floating: !1 })}"
          >Close
        </vaadin-button>
      </div>
    `;
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = Fe, i = "Install from JetBrains Marketplace") : e.vscode && (t = qe, i = "Install from VSCode Marketplace"), l`
      <div>
  ...
  renderHotswapAgentJdkSection(e) {
    const t = r.jdkInfo?.extendedClassDefCapable, i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === be;
    return l`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && yt("1.3.0", r.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : u}
              ...
              <li>
                ${e.intellij || e.vscode ? l`If there is a problem, you can manually
                      ...
                      your debug configuration to use it.` : l`<a target="_blank" href="${ve}">Download JetBrains Runtime JDK</a> and set up
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], De(`${Ve}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (Je("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, be];
    });
  }
...
c.addPanel(he);
var Pt = Object.getOwnPropertyDescriptor, At = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Pt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = a(o) || o);
  return o;
};
...
function f(e) {
  return Me("vaadin-menu-bar-item", e);
}
function Z(e) {
  return Me("vaadin-context-menu-item", e);
}
function Me(e, t) {
  ...
  if (t.label) {
    ...
    const n = Xe(t.component) ? t.component : document.createElement(t.component);
    i.append(n);
  }
  if (t.hint) {
    const n = document.createElement("span");
...
function _e(e) {
  return De("copilot-switch-user", { username: e }, (t) => t.data.error ? (Y({ type: W.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
var $t = Object.defineProperty, St = Object.getOwnPropertyDescriptor, O = (e, t, i, n) => {
...
function Dt() {
  ...
  return e.label = "Username to Switch To", e.style.width = "100%", e.autocomplete = "off", e.addEventListener("click", async (t) => {
    ...
    if (t.stopPropagation(), t.key === "Enter") {
      const i = e.value;
      await _e(i) && (p.addRecentSwitchedUsername(i), window.location.reload());
    }
  }), e;
}
...
let N = class extends I {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      return i ? Array.from(i).some((o) => {
        ...
        if (!s)
          return !1;
        const a = s.getBoundingClientRect(), h = n.getBoundingClientRect(), m = Math.min(a.x, h.x), v = Math.min(a.y, h.y), x = Math.max(a.width, h.width), U = a.height + h.height;
        return Se(new DOMRect(m, v, x, U), e.clientX, e.clientY);
      }) : !1;
        ...
        children: [
            ...
            children: [
              ...
              },
              {
                ...
                action: (o) => {
                  ...
                  a === "ask" ? s = "yes" : a === "no" ? s = "ask" : s = "no", p.setAIUsageAllowed(s), zt(o);
                }
              },
              {
                component: f({
          ...
          },
          {
            component: f({
              icon: d.vaadinLogo,
              label: "Copilot",
              hint: p.isActivationShortcut() ? V.toggleCopilot : void 0,
  ...
  handleMenuItemClick(e) {
    e.action && (e.action(e), e.keepOpen && Et());
  }
  firstUpdated() {
...
var Lt = Object.defineProperty, Mt = Object.getOwnPropertyDescriptor, H = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Mt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
...
let D = class extends I {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      const { width: t, height: i } = this.getBoundingClientRect(), { left: n, top: o, bottom: s, right: a } = P.anchor(this), h = window.getComputedStyle(this.container), m = Number.parseInt(h.borderTopWidth, 10), v = Number.parseInt(h.borderBottomWidth, 10);
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), fe(this), this.panelInfo?.floating)
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            r.operationInProgress === re.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      ...
      fe(this), c.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: i + 1 });
    }
...
g.on("undoRedo", (e) => {
  const i = { files: Tt(e), uiId: Ze() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o = e.detail.undo ? "undo" : "redo";
  Qe(o), _t(re.RedoUndo), g.send(n, i);
});
function Tt(e) {
  ...
  return e.detail.files ?? et();
}
var Ot = Object.getOwnPropertyDescriptor, Ht = (e, t, i, n) => {
...
Ae ? Ae.add((e, t) => {
  e === "loading" && t === "connected" && r.active && pe();
...
const Bt = {
   ...
   */
  run(e) {
    se || (se = !0, queueMicrotask(() => jt())), z.push(e);
    const t = Ie;
    return Ie += 1, t;
  },
  /**
...
const B = (e, t) => {
  ...
  for (const n of i) n._$AO?.(t, !1), B(n, t);
  return !0;
}, q = (e) => {
  let t, i;
  do {
...
function Nt(e) {
  this._$AN !== void 0 ? (q(this), this._$AM = e, He(this)) : this._$AM = e;
}
function Jt(e, t = !1, i = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) B(n[s], !1), q(n[s]);
  else n != null && (B(n, !1), q(n));
  else B(this, e);
}
const Vt = (e) => {
  e.type == ze.CHILD && (e._$AP ??= Jt, e._$AQ ??= Nt);
};
class Ft extends st {
  constructor() {
  ...
  setValue(t) {
    if (at(this._$Ct)) this._$Ct._$AI(t, this);
    else {
...
class qt extends Ft {
  ...
  /** @override */
  update(t, [i, n]) {
    return this.hasChanged(n) ? (this.host = t.options && t.options.host, this.element = t.element, this.renderer = i, this.previousValue === $e ? this.addRenderer() : this.runRenderer(), this.previousValue = Array.isArray(n) ? [...n] : n, u) : u;
  }
  /** @override */
  reconnected() {
    this.addRenderer();
...
const Gt = de(Xt), Kt = de(Yt), Zt = de(Wt);
var Qt = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, Ue = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? ei(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && Qt(t, i, o), o;
};
let ae = class extends ke {
  ...
  firstUpdated(e) {
    super.firstUpdated(e), ce(this.renderRoot);
  }
  render() {
